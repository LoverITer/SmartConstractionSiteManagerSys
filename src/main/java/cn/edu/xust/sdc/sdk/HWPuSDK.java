...
import static cn.edu.xust.sdc.sdk.HWPuSDK.LAYER_THREE_TYPE_E.*;
...
/************************** Macro Definition Ends   ***************************/
    ...
    public interface ERROR_CODE {
        ...
        public final int PU_ERROR_CODE_OPERATION_TIMEOUT = 12;                           //Failed to allocate the memory due to insufficient memory space.
        public final int PU_ERROR_CODE_OUT_OF_MEMORY = 13;                               //The link is disconnected on the server.
        public final int PU_ERROR_CODE_SERVER_IS_SHUTDOWN = 14;                          //The number of live video channels exceeded the maximum.
        ...
        public final int PU_ERROR_CODE_FILE_FORMAT_INVALID = 23;                         //Failed to verify the digital watermark of the snapshot.
        ...
        //API invoking error.
        public static final int PU_ERROR_CODE_SDKINIT_LINK_MODE_ERROR = 101;                    //A connection mode error occurred during SDK initialization.
        public static final int PU_ERROR_CODE_SDKINIT_LOCALIP_ERROR = 102;                      //A local IP address error occurred during SDK initialization.
        ...
        public static final int PU_ERROR_CODE_SDKGETVERSION_PARA_ERROR = 105;                   //An error occurred when obtaining the version.
        public static final int PU_ERROR_CODE_IDENTIFYID_ERROR = 106;                           //Incorrect user ID.
        public static final int PU_ERROR_CODE_SDKGETDEVICE_PARA_ERROR = 107;                    //An error occurred when obtaining the device parameter settings.
        public static final int PU_ERROR_CODE_ALARMREPORT_CB_IS_NULL = 108;                     //The alarm reporting callback function is empty.
        public static final int PU_ERROR_CODE_VOICETB_CB_IS_NULL = 109;                         //The voice intercom callback function is empty.
        public static final int PU_ERROR_CODE_REALPLAY_CB_IS_NULL = 110;                        //The live video viewing callback function is empty.
        public static final int PU_ERROR_CODE_LOAD_PLAYDLL_ERROR = 111;                         //An error occurred when loading the video library.
        ...
        public static final int PU_ERROR_CODE_SDKSETPLATFORM_PARA_ERROR = 118;                  //An error occurred when setting platform parameters.
        ...
        public static final int PU_ERROR_CODE_ALARM_MOTION_DETEC_PARA_ERROR = 125;              //Motion detection alarm parameter error.
        public static final int PU_ERROR_CODE_ALARM_INPUT_PARA_ERROR = 126;                     //Boolean value input alarm parameter error.
        public static final int PU_ERROR_CODE_ALARM_HIDE_PARA_ERROR = 127;                      //Lens blocking alarm parameter error.
        public static final int PU_ERROR_CODE_ALARM_INVADE_PARA_ERROR = 128;                    //Intrusion detection alarm parameter error.
        ...
        public static final int PU_ERROR_CODE_SDKGUARD_PARA_ERROR = 134;                        //Alert deployment and withdrawal parameter error.
        public static final int PU_ERROR_CODE_SDKGETALARAM_PARA_ERROR = 135;                    //An error occurred when obtaining alarm parameter settings.
        public static final int PU_ERROR_CODE_PARA_ERROR = 136;                                 //Parameter error.
        public static final int PU_ERROR_CODE_PLAYER_FUNC_ERROR = 137;                          //An error occurred when invoking the video library function.
        public static final int PU_ERROR_CODE_SDKSAVEREALDATA_ERROR = 138;                      //Save live video data.
        public static final int PU_ERROR_CODE_SDKGETGUARDSTATE_PARA_ERROR = 139;                //An error occurred when obtaining the alert deployment status parameter.
        public static final int PU_ERROR_CODE_MUTUALLYEXCLUSIVE_RELATIONSHIP = 140;             //The setting fails because of mutual exclusion.
        ...
        public static final int PU_ERROR_CODE_MISMATCH_PWD_COMPLEXITY = 145;                    //The password does not meet the complexity requirements.
        public static final int PU_ERROR_CODE_ALARM_AUDIO_UP_PARA_ERROR = 146;                    //Sudden volume increase alarm parameter error.
        public static final int PU_ERROR_CODE_ALARM_AUDIO_DOWN_PARA_ERROR = 147;                //Sudden volume decrease alarm parameter error.
        public static final int PU_ERROR_CODE_TRANSPARENT_CHANNEL_DATA_CB_IS_NULL = 148;        //The data callback function of the transparent channel is empty.
        ...
        public static final int PU_ERROR_CODE_IMPORT_FACELIBRARY_ERROR = 152;                   //An error occurred when importing face images into the face library.*/
        public static final int PU_ERROR_CODE_IMPORTING_FACELIB_ERROR = 153;                    //Importing face images into a face library...*/
        public static final int PU_ERROR_CODE_UNKNOWN_SV_TYPE = 154;                            //Unknown service type.*/
        public static final int PU_ERROR_CODE_NOT_OPEN_TLS = 155;                               //Operations related to the face library cannot be performed because the TLS is not enabled.*/
        public static final int PU_ERROR_INVALID_UPDATEFILE_NUM = 156;                        //The number of upgrade files exceeded the maximum.*/
        public static final int PU_ERROR_USER_CANCEL_UPGRADE = 157;                           //Upgrade canceled.*/
        public static final int PU_ERROR_NOT_ENOUGH_MEMORY_ALLOCATED = 160;                   //JSON data cannot be loaded because the input receive cache is too small.*/
        ...
        public static final int PU_ERROR_CODE_NULL_ELEMENT = 10101;                             //The XML file does not have the corresponding node.
        ...
        public static final int PU_ERROR_CODE_INVALID_ROOTFS_FILE = 10105;                      //Failed to verify the file system upgrade file.
        ...
        public static final int PU_ERROR_CODE_NOT_NEED_UPDATE = 10113;                          //No upgrade is required because the versions are consistent.
        public static final int PU_ERROR_CODE_NOT_SUPPORT_ABILITY = 10114;                      //The capability parameter is not supported.
        public static final int PU_ERROR_CODE_PRESET_IN_GUARD_POSITION = 10115;                 //The preset position has been configured as the home position.
        public static final int PU_ERROR_CODE_PRESET_IN_CRUISE_TRACK = 10116;                   //The preset position has been added to the tour.
        public static final int PU_ERROR_CODE_SET_ETHPHY_OUTPUT_TYPE_ERROR = 10117;             //Failed to set the network port type.
        public static final int PU_ERROR_CODE_SET_ETHMODE_ERROR = 10118;                        //Failed to set the network port rate.
        public static final int PU_ERROR_CODE_UPLOAD_CONFIG_TYPE_ERROR = 10119;                 //The type of the configuration file to upload is incorrect.
        public static final int PU_ERROR_CODE_DNS_SERVER_UNREACH = 10120;                       //The DNS server is unreachable.
        public static final int PU_ERROR_CODE_DNS_SERVER_NO_DOMAIN = 10121;                     //The DNS server failed to obtain the domain name.
        ...
        public static final int PU_ERROR_CODE_RECOVER_OPRATE_FORBIDDEN = 10128;                 //Configuration operations cannot be performed during default setting restoration.
        public static final int PU_ERROR_CODE_ROI_ERROR_BY_MJPEG = 10129;                       //Failed to set the ROI in the MJPEG standard.
        public static final int PU_ERROR_CODE_ROI_ERROR_BY_NOSUBSTREAM = 10130;                 //The ROI failed to be set for the secondary stream when only the primary stream is available.
        public static final int PU_ERROR_CODE_TZ_ERROR_BY_CONFLICT = 10131;                     //A conflict occurred when tripwire crossing detection is enabled.
        public static final int PU_ERROR_CODE_OC_ERROR_BY_CONFLICT = 10132;                     //A conflict occurred when object counting is enabled.
        public static final int PU_ERROR_CODE_MD_ERROR_BY_CONFLICT = 10133;                     //A conflict occurred when motion detection is enabled.
        public static final int PU_ERROR_CODE_TW_ERROR_BY_CONFLICT = 10134;                     //A conflict occurred when tripwire crossing detection is enabled.
        public static final int PU_ERROR_CODE_AREA_ERROR_BY_CONFLICT = 10135;                   //A conflict occurred when intrusion detection, abandoned object detection, or removed object detection is enabled.
        public static final int PU_ERROR_CODE_VD_ERROR_BY_CONFLICT = 10136;                     //A conflict occurred when video interference detection is enabled.
        public static final int PU_ERROR_CODE_IGT_ENABLE_CONFLICT = 10137;                      //Failed to enable illumination enhancement or lens blocking detection because the intelligent analysis function has been enabled.
        public static final int PU_ERROR_CODE_ILLUMINATION_ENABLE_CONFLICT = 10138;             //Failed to enable intelligent analysis or lens blocking detection because the illumination enhancement function has been enabled.
        public static final int PU_ERROR_CODE_VIDEOBLOCK_ENABLE_CONFLICT = 10139;               //Failed to enable intelligent analysis or illumination enhancement because the lens blocking detection function has been enabled.
        public static final int PU_ERROR_CODE_IGT_FAIL_BY_SWITCHOFF = 10140;                    //Failed to set the intelligent service because the intelligent analysis function is not enabled.
        public static final int PU_ERROR_CODE_TW_ERROR_BY_OVER_NUM = 10141;                     //The number of tripwires exceeded the maximum.
        public static final int PU_ERROR_CODE_AREA_ERROR_BY_OVER_NUM = 10142;                   //The number of areas exceeded the maximum value, 4.
        public static final int PU_ERROR_CODE_AREA_ERROR_BY_OVER_TOTAL_NUM = 10143;             //The number of areas exceeded the maximum value, 10.
        public static final int PU_ERROR_CODE_AREA_ERROR_BY_ZERO_NUM = 10144;                   //The number of areas is 0.
        public static final int PU_ERROR_CODE_AREA_POINT_ERROR_BY_OVER_NUM = 10145;             //The number of area vertexes exceeded the maximum.
        public static final int PU_ERROR_CODE_AREA_ABN_ERROR_BY_CONFLICT = 10146;               //A conflict occurred when abandoned object detection is enabled. The removed object detection has been enabled.
        public static final int PU_ERROR_CODE_AREA_RMV_ERROR_BY_CONFLICT = 10147;               //A conflict occurred when removed object detection is enabled. The abandoned object detection has been enabled.
        public static final int PU_ERROR_CODE_VIM_GLOBAL_PARA_ERROR = 10148;                    //Failed to set global parameters for the intelligent analysis algorithm.
        public static final int PU_ERROR_CODE_AREA_NOTSURPORT_ERROR = 10149;                    //Invalid intelligent analysis area.
        public static final int PU_ERROR_CODE_PRIVACY_MASK_AREA_BEYOND = 10150;                 //The privacy mask area exceeds the total area.
        public static final int PU_ERROR_CODE_MEDIA_ADAPT_BW_MUTEX = 10151;                     //The adaptive bandwidth function conflicts with the encoding type or bit rate type.
        public static final int PU_ERROR_CODE_IP_FILTER_RULE_SAME = 10152;                      //Duplicate IP address filtering rule.
        public static final int PU_ERROR_CODE_WD_FRAME_CONFLICT = 10153;                        //If the WDR mode is set to manual or auto, the collection frame rate cannot be set to 50 or 60 fps.
        public static final int PU_ERROR_CODE_FRAME_WD_CONFLICT = 10154;                        //If the collection frame rate is set to 50 or 60 fps, the WDR mode cannot be set to manual or auto.
        public static final int PU_ERROR_CODE_CONFLICT_VIDEOBLOCK_OR_IGT_IS_ENABLE = 10155;     //Failed to set the illuminance enhancement because the lens blocking detection or behavior analysis function is enabled.
        ...
        public static final int PU_ERROR_CODE_INVALID_IGT_AREA_ID = 10159;                      //The intelligent analysis area does not exist.
        public static final int PU_ERROR_CODE_INVALID_IGT_LINE_ID = 10160;                      //The intelligent analysis line does not exist.
        public static final int PU_ERROR_CODE_INVALID_PRIVACY_ID = 10161;                       //The privacy mask area does not exist.
        public static final int PU_ERROR_CODE_IN_USER_DEFINE_SCAN = 10162;                      //Pattern scan is in progress (many functions are unavailable).
        public static final int PU_ERROR_CODE_SET_DRC_BACKLIGHT_CONFLICT = 10163;               //The backlight compensation and DRC functions cannot be enabled at the same time.
        public static final int PU_ERROR_CODE_CURISE_IN_GUARD_POSITION = 10164;                 //A preset position in the tour has been configured as the home position.
        ...
        public static final int PU_ERROR_CODE_INVALID_SAMEPASSWD = 10167;                       //The new password must be different from the old password.
        public static final int PU_ERROR_CODE_NOT_SUPPORTED_UPDATE = 10168;                     //The version of the upgrade file is too early. Upgrade the file to a later version.
        public static final int PU_ERROR_CODE_MANY_RECORD_FILES = 10169;                        //Too many recording files.
        public static final int PU_ERROR_CODE_CONFLICT_WITH_MOSAIC = 10170;                     //The operation conflicts with the mosaic setting.
        public static final int PU_ERROR_CODE_CONFLICT_WITH_OSD = 10171;                        //The operation conflicts with the OSD setting.
        ...
        public static final int PU_ERROR_CODE_WB_HIGH_TEMP_LOWER = 10175;                       //The lower limit of the color temperature must be less than the upper limit in automatic tracking white balance mode.
        public static final int PU_ERROR_CODE_MJPEG_UNSUPPORT_WATERMARK = 10176;                //The MJPEG does not support the digital watermark function.
        public static final int PU_ERROR_CODE_ISP_CONFLICT_WITH_FRAMERATE = 10177;              //WDR or backlight compensation is mutually exclusive with the full frame rate.
        public static final int PU_ERROR_CODE_FRAMERATE_CONFLICT_WITH_ISP = 10178;              //Full frame rate is mutually exclusive with WDR or backlight compensation.
        ...
        public static final int PU_ERROR_CODE_IMPORTING_FACE_LIB = 10184;                       //Importing data into the face library... Please wait.
        public static final int PU_ERROR_CODE_ADDING_ONE_FACE = 10185;                          //Adding faces... Please wait.
        public static final int PU_ERROR_CODE_AUDIO_DETECT_MIC_NOT_SUPPORT = 10200;             //Audio exception detection is not supported in the case of MIC connection.
        public static final int PU_ERROR_CODE_CIF_CONFLICT = 10202;                             //The CIF cannot be set because it is mutually exclusive with the corridor mode.
        public static final int PU_ERROR_CODE_CORRIDOR_CONFLICT = 10203;                        //The corridor cannot be set because it is mutually exclusive with the CIF.
        ...
        public static final int PU_ERROR_ISP_AE_MANUAL_CONFLICT_WD = 10214;        //Manual exposure and WDR are mutually exclusive.
        public static final int PU_ERROR_ISP_AE_MANUAL_CONFLICT_FLICKER = 10215;   //The manual exposure and background frequency are mutually exclusive.
        public static final int PU_ERROR_ISP_AE_MANUAL_CONFLICT_HLC = 10216;       //Manual exposure and highlight compensation are mutually exclusive.
        public static final int PU_ERROR_ISP_AE_SHUTPRI_CONFLICT_WD = 10217;       //Manual exposure and WDR are mutually exclusive.
        public static final int PU_ERROR_ISP_AE_SHUTPRI_CONFLICT_FLICKER = 10218; //The shutter priority exposure mode and background frequency are mutually exclusive.
        public static final int PU_ERROR_ISP_AE_SHUTPRI_CONFLICT_HLC = 10219; //The shutter priority exposure mode and highlight compensation are mutually exclusive.
        public static final int PU_ERROR_ISP_BACKLIGHT_CONFLICT_WD = 10220;   //Backlight compensation and WDR are mutually exclusive.
        public static final int PU_ERROR_ISP_BACKLIGHT_CONFLICT_HLC = 10221;  //Backlight compensation and highlight compensation are mutually exclusive.
        public static final int PU_ERROR_ISP_WD_CONFLICT_HLC = 10222; //WDR and highlight compensation are mutually exclusive.
        public static final int PU_ERROR_ISP_DEFOG_CONFLICT_WD = 10223;   //The defogging mode and WDR are mutually exclusive.
        public static final int PU_ERROR_ISP_HLC_CONFLICT_FRAMERATE = 10224;  //Highlight compensation is mutually exclusive with the frame rate of 50 or 60 fps.
        public static final int PU_ERROR_ISP_WD_CONFLICT_FRAMERATE = 10225;   //WDR is mutually exclusive with the frame rate of 50 or 60 fps.
        public static final int PU_ERROR_ISP_AE_MANUAL_CONFLICT_BACKLIGHT = 10226;    //Manual exposure and backlight compensation are mutually exclusive.
        public static final int PU_ERROR_ISP_HLC_CONFLICT_SLOW_SHUTTER = 10227;   //Highlight compensation and slow shutter are mutually exclusive.
        public static final int PU_ERROR_ISP_WD_CONFLICT_SLOW_SHUTTER = 10228;    //WDR and slow shutter are mutually exclusive.
        ...
        public static final int PU_ERROR_CODE_UPGRADE_TYPE_ERR = 10350;                      //The upgrade file type does not match the request type.
        ...
        public static final int PU_ERROR_CODE_UPGRADE_VERIFY_FAIL = 10353;                      //Failed to verify the integrity of the upgrade file.
        public static final int PU_ERROR_CODE_UPGRADE_SIGN_FAIL = 10354;                      //Failed to verify the digital signature of the upgrade file.
        ...
        public static final int PU_ERROR_RESULT_ALG_VER_ERR_U = 10357;                         //The algorithm package version is incorrect. The algorithm package version must be consistent with the VRC version of the software package.
        public static final int PU_ERROR_RESULT_ALG_VER_NEED_UPGRADE_U = 10358;                //The algorithm package needs to be upgraded after the version package is upgraded.
        public static final int PU_ERROR_SD_NOT_FORMAT = 10601;                                 //The SD card is not formatted.
        public static final int PU_ERROR_CODE_CUSTOM_PACKAGE_UNDEFINED = 10602;                    //The customized profile is not defined.
        public static final int PU_ERROR_CODE_PTZ_BUSY = 10603;                                 //The PTZ is not stopped.
        public static final int PU_ERROR_CODE_OSDI_AREA_NOT_EXIST = 10700;                        //The area does not exist. The index value is incorrect.
        public static final int PU_ERROR_CODE_OSDI_AREA_TOO_LARGE = 10701;                        //The horizontal width of the area exceeds 180 degrees.
        public static final int PU_ERROR_CODE_OSDI_AREA_INVALID_VERDEGREE = 10702;                //The area coordinate does not comply with the lower-left and upper-right rules.
        public static final int PU_ERROR_CODE_OSDI_INDEX_AlREADY_EXIST = 10705;                 //The index number of the new area is invalid. The index already exists.
        public static final int PU_ERROR_CODE_OSDI_HOR_OR_VER_EQUAL = 10708;                    //The horizontal coordinate and vertical coordinate of the area are the same.
        public static final int PU_ERROR_CODE_OSDI_INDEX_INVALID = 10709;                       //The area index number is invalid. It must be smaller than 1.
        ...
        public static final int PU_STABILIZER_CONFLICT_AREA_CROP = 10900;                       //Failed to enable the electronic image stabilization function. This function is mutually exclusive with area cropping.
        public static final int PU_AREA_CROP_CONFLICT_STABILIZER = 10901;                       //Failed to enable area cropping. This function is mutually exclusive with the electronic image stabilization function.
        ...
        public static final int PU_ERROR_CODE_ITGT_IMRS_ERR_RESOLUTION_DIFF = 10954;            //The resolution is different from the initial resolution.
        ...
        public static final int PU_ERROR_RESULT_VLPR_ERR_LINE_OUTOF_RANGE = 10964;              //Setting failed. The detection line is out of the lane line.
        ...
        public static final int PU_ERROR_CODE_GET_TEMPERTURE_VW_RET_FAIL = 11024;               //Failed to invoke the VM interface. For example, the driver is invoked to obtain the temperature.
        ...
        public static final int PU_RESULT_ITS_ERR_INVALID_LANE_DRV_DIR = 11103;                        //Invalid regulated driving direction of the lane.
        ...
        public static final int PU_RESULT_ITS_ERR_INVALID_NORMAL_SIGN_SPEED = 11108;                    //Invalid marked speed for small vehicles.
        public static final int PU_RESULT_ITS_ERR_INVALID_NORMAL_LOW_SPEED = 11109;                    //Invalid lower speed limit for small vehicles.
        public static final int PU_RESULT_ITS_ERR_INVALID_NORMAL_HIGH_SPEED = 11110;                    //Invalid upper speed limit for small vehicles.
        public static final int PU_RESULT_ITS_ERR_INVALID_BIGVEHICLE_SIGN_SPEED = 11111;                //Invalid marked speed for large vehicles.
        public static final int PU_RESULT_ITS_ERR_INVALID_BIGVEHICLE_LOW_SPEED = 11112;                //Invalid lower speed limit for large vehicles.
        public static final int PU_RESULT_ITS_ERR_INVALID_BIGVEHICLE_HIGH_SPEED = 11113;                //Invalid upper speed limit for large vehicles.
        public static final int PU_RESULT_ITS_ERR_INVALID_EXTERN_LAMP_BITMAP = 11114;                    //Invalid external illuminator association.
        public static final int PU_RESULT_ITS_ERR_INVALID_SNAP_INTERVAL = 11115;                        //The snapshot interval is out of range.
        public static final int PU_RESULT_ITS_ERR_INVALID_DT_TYPE = 11116;                                //The detection mode is out of range.
        public static final int PU_RESULT_ITS_ERR_INVALID_REGULATION_NUM = 11117;                        //The number of violations exceeded the maximum.
        public static final int PU_RESULT_ITS_ERR_INVALID_REGULATION_TYPE = 11118;                        //Invalid violation type.
        public static final int PU_RESULT_ITS_ERR_INVALID_SNAP_NUM = 11119;                            //The number of traffic violation snapshots is out of range.
        public static final int PU_RESULT_ITS_ERR_INVALID_RUNNINGRED_PRIORITY = 11120;                    //Invalid red-light-running detection priority.
        public static final int PU_RESULT_ITS_ERR_INVALID_OVER_LANE_SENSITIVITY = 11121;                //The sensitivity for detecting marked lanes violations is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_VINBIKELANE_STAYTIME = 11122;                //The dwell duration for detecting motor vehicles on non-motor vehicle lanes is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_OVER_BUSLANE_STAYTIME = 11123;                //Invalid bus lane occupation time.
        public static final int PU_RESULT_ITS_ERR_INVALID_PARKINGTIME = 11124;                            //Invalid dwell duration for detecting parking in yellow zones.
        public static final int PU_RESULT_ITS_ERR_INVALID_LIGHT_DT_TYPE = 11125;                        //The traffic light access mode is out of range.
        public static final int PU_RESULT_ITS_ERR_INVALID_LIGHT_AREA_NUM = 11126;                        //Invalid number of traffic light areas.
        public static final int PU_RESULT_ITS_ERR_INVALID_LIGHT_NUM = 11127;                            //Invalid number of traffic lights.
        public static final int PU_RESULT_ITS_ERR_INVALID_LIGHT_ARRANGE_TYPE = 11128;                    //Invalid traffic light direction.
        ...
        public static final int PU_RESULT_ITS_ERR_LINE_OUTOF_RANGE = 11131;                            //The detection line or stop line is out of the lane line or right boundary line range.
        public static final int PU_RESULT_ITS_ERR_INVALID_NORMAL_SPEED_RANGE_CONFIG = 11132;          //If the lower speed limit for small vehicles is greater than the upper speed limit, an error is returned.
        public static final int PU_RESULT_ITS_ERR_INVALID_NORMAL_SIGN_SPEED_CONFIG = 11133;             //If the marked speed for small vehicles is out of range, an error is returned.
        public static final int PU_RESULT_ITS_ERR_INVALID_BIGVEHICLE_SPEED_RANGE_CONFIG = 11134;    //If the lower speed limit for large vehicles is greater than the upper speed limit, an error is returned.
        public static final int PU_RESULT_ITS_ERR_INVALID_BIGVEHICLE_SIGN_SPEED_CONFIG = 11135;      //If the marked speed for large vehicles is out of range, an error is returned.
        ...
        public static final int PU_RESULT_ITS_ERR_INVALID_ADAPT_SNAP_LOWSPEED = 11139;              //The maximum low speed of the adaptive snapshot interval is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_ADAPT_SNAP_MIDSPEED = 11140;              //The maximum medium speed of the adaptive snapshot interval is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_ADAPT_LOWSPEED_INTERVAL = 11141;          //The adaptive low-speed snapshot interval is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_ADAPT_MIDSPEED_INTERVAL = 11142;          //The adaptive medium-speed snapshot interval is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_ADAPT_HISPEED_INTERVAL = 11143;           //The adaptive high-speed snapshot interval is invalid.
        public static final int PU_RESULT_ITS_ERR_INVALID_LANE_ORDER = 11144;                       //Setting failed. Draw lane lines and the right lane boundary from left to right in sequence.


        //Algorithm conflict error codes
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_LRPR = 12000; //Failed to set license plate recognition because it conflicts with facial recognition, behavior analysis, or parking detection.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_FD = 12001; //Failed to set face detection because it conflicts with license plate recognition or parking detection.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_CD = 12002; //Failed to set parking detection because it conflicts with facial recognition, license plate recognition, or behavior analysis.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_VA = 12003; //Failed to set behavior analysis because it conflicts with license plate recognition or behavior analysis.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_HC = 12004; //Failed to set head counting because it conflicts with license plate recognition, facial recognition, parking detection, or automatic tracking.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_AT = 12005; //Failed to set automatic tracking because it conflicts with license plate recognition, facial recognition, parking detection, or head counting.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_VHD = 12006; //Disable the object classification function first.
        ...
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_CDD = 12009; //Disable the crowd density detection function first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_IBALL = 12010; //Disable the traffic violation detection of the PTZ dome camera first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_VHDFACE = 12011; //Disable the full intelligence mode first.
        public static final int PU_RESULT_ITGT_MODE_NOTSUPPORT_ALG = 12012; //This algorithm is not supported in the current mode.
        public static final int PU_RESULT_TGT_VHD_DETECTION_ERR_WRONG_VIDEO_MODE = 12013; //Object classification does not support the corridor mode. Disable the corridor mode first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_BEH = 12014; //Disable the behavior analysis function in enhanced mode.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_CAMPUS_TRAFFICEVENT = 12015; //Disable vehicle detection at entrances and exits first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_CAMPUS_ALG_TYPE = 12016; //The vehicle detection at entrances and exits supports only Chinese license plate recognition algorithms.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_MD = 12017; //Disable the motion detection function first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_OD = 12018; //Disable the lens blocking detection function first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_SC = 12019; //Disable the scene change detection function.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_OOD = 12020; //Disable the defocus detection function first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_CA = 12021; //Disable the crowd gathering detection function first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_HM = 12022; //Disable the heat map function first.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_TRAFFICEVENT_CAMPUS = 12023; //Disable all vehicle event detection functions.
        public static final int PU_RESULT_TGT_FUNCTION_MUTUAL_TRAFFIC_STATISTIC_CAMPUS = 12024; //Disable the traffic flow statistics function first.
        ...
        public static final int PU_RESULT_ITGT_ERR_OPREATION_UNFINISHED = 12104;               //The batch import operation is not complete.
        public static final int PU_RESULT_ITGT_ERR_FACELIB_OVERSIZE = 12105;                   //The number of face libraries exceeds the upper limit.
        public static final int PU_RESULT_ITGT_ERR_FACinterface_OVERSIZE = 12106;                   //The number of faces exceeds the upper limit.
        ...
        public static final int PU_RESULT_ITGT_ERR_FACEPIC_OVERSIZE = 12109;                   //The image width or height is out of range.
        ...
        public static final int PU_RESULT_ITGT_ERR_FACEREC_ENABLE_FAIL = 12123;                //The facial recognition function fails to be enabled because the algorithm package does not exist or the version does not match.
        public static final int PU_RESULT_ITGT_ERR_FACE_FEATURE_LOAD_PROCESSING = 12124;       //Facial recognition has historical alert deployment. Features need to be loaded when the system is started.
        public static final int PU_RESULT_ITGT_ERR_FACE_FEATURE_PAC_IMPORT_PROCESSING = 12125; //The feature package is being imported.
        public static final int PU_RESULT_ITGT_ERR_FACE_PIC_PAC_IMPORT_PROCESSING = 12126;     //The image package is being imported.
        public static final int PU_RESULT_ITGT_ERR_FACE_FEATURE_GET_PROCESSING = 12127;        //Features are being exported.
        public static final int PU_RESULT_ITGT_ERR_FACE_FEATURE_EXTRACT_PROCESSING = 12128;    //Features are being extracted.

        //Parking detection error codes
        public static final int PU_RESULT_TGT_CAR_DATECTION_ERR_WRONG_VIDEO_MODE = 12200;     //When parking detection is enabled, the corridor mode and mirroring mode must be disabled.
        public static final int PU_RESULT_ITGT_VHD_ERR_WRONG_VIDEO_MODE = 12201;                    //The object classification and the corridor mode cannot be enabled at the same time.
        public static final int PU_RESULT_ITGT_VLPR_ERR_WRONG_VIDEO_MODE = 12202;                   //The vehicle recognition and the corridor mode cannot be enabled at the same time.
        public static final int PU_RESULT_ITGT_NOT_FACE_DETETION_MODE_ERR_WRONG_VIDEO_MODE = 12203; //(The corridor mode must be disabled for -H camera models in non-face checkpoint mode (not supported in full intelligence, micro checkpoint, and behavior analysis modes).)
        public static final int PU_RESULT_LIC_INVALID = 12300;                          //Failed to obtain the license content due to the invalid license.
        public static final int PU_RESULT_LIC_REPEATED_ESN_VER_MISMATCH = 12301;               //The ESN cannot be loaded repeatedly or the license file that does not match the device version cannot be loaded.
        public static final int PU_RESULT_LIC_FORMAT_ERROR = 12302;                            //Invalid license file.
        public static final int PU_RESULT_LIC_NO_PRD_FEATURES_PRESENT = 12303;                 //The license file does not contain the product feature segment.
        ...
        public static final int PU_RESULT_LIC_GET_CONFIG_ERROR = 12306;                        //Failed to obtain the control item configuration.
        public static final int PU_RESULT_LIC_LSN_REVOKED = 12307;                             //The license file has expired.
        public static final int PU_RESULT_LIC_ESNANY_AND_SIX_MON_VLDITY_NOT_ALLOWED = 12308;   //You are not allowed to repeatedly load a commissioning license file whose ESN is ANY and validity period is six months.
        public static final int PU_RESULT_LIC_MAX_FEATURES_REACHED = 12309;                    //The number of features in the license file exceeds the maximum.
        public static final int PU_RESULT_LIC_INVALID_FEATURE_TYPE = 12310;                    //The feature type in the license file is incorrect.
        public static final int PU_RESULT_LIC_LM_NOT_ENABLED = 12311;                          //The license component is not started.
        public static final int PU_RESULT_LIC_NO_FEATURES_IN_NORMAL_STATE = 12312;             //All features in the license file expired or are in the trial period.
        public static final int PU_RESULT_LIC_ESN_MISMATCH = 12313;                            //The ESN in the license file is different from the actual ESN.
        public static final int PU_RESULT_LIC_VERSION_MISMATCH = 12314;                        //The device version in the license file is different from the actual version.
        ...
        public static final int PU_RESULT_MEDIA_UTGT_NOT_ENABLED = 12780;              /*An intelligent analysis channel needs to be created for media streams, but the intelligent analysis module is not enabled.*/
        //Algorithm switchover
        public static final int PU_RESULT_TGT_SWITCH_MODE_ERR_WRONG_VIDEO_MODE = 12800; //The switched mode does not support the corridor mode.
        public static final int PU_RESULT_TGT_SWITCH_MODE_ERR_ENABLE_ALG = 12801;               //Failed to enable the algorithm for the switched mode. Check the model.
        public static final int PU_RESULT_TGT_SWITCH_MODE_FTP_NEED_RECONFIG = 12802;            //The mode is switched successfully. The FTP needs to be reconfigured.
        public static final int PU_ERROR_MAX = 20000;
    }

    //The request type REQ_NULL indicates the situation that no value is assigned after initialization.
    ...
    public interface PU_LINK_MODE {
        public static final int PU_AUTOLOGIN_MODE = 0;                                          //Proactive login mode. After the initialization, the PU proactively logs in to the SDK. Only the decoder supports this mode.
        public static final int PU_MANUALLOGIN_MODE = 1;                                        //In manual login mode, you need to manually invoke the IVS_PU_Login to log in to the PU.
    ...
    public interface PU_EVENT_TYPE {
        ...
        public static final int PU_EVENT_TYPE_NOT_REGISTER = 3;                                     //The PU is not registered with the platform after proactively connecting to the network.
        ...
        public static final int PU_EVENT_TYPE_UPLOAD_IMAGE_URL = 10;                                 //The PU proactively obtains the URL for uploading snapshots.
        public static final int PU_EVENT_TYPE_UPLOAD_IMAGE_COMP_NOTIFY = 11;                         //Send a PU-triggered snapshot upload completion notification.
        ...
        public static final int PU_EVENT_TYPE_RECORD_COMP_NOTIFY = 16;                                //Send a recording download completion notification.
    ...
    public interface PU_PTZ_OPCODE {
        ...
        public static final int PU_PTZ_UP = 2;                              //Rotate the PTZ upward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_DOWN = 3;                            //Rotate the PTZ downward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_LEFT = 4;                            //Rotate the PTZ leftward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_UP_LEFT = 5;                         //Rotate the PTZ upper leftward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_DOWN_LEFT = 6;                       //Rotate the PTZ lower leftward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_RIGHT = 7;                           //Rotate the PTZ rightward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_UP_RIGHT = 8;                        //Rotate the PTZ upper rightward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_DOWN_RIGHT = 9;                      //Rotate the PTZ lower rightward. The param1 parameter indicates the rotation mode. The value 1 indicates the step mode. The value 2 indicates the continuous mode. The param2 parameter specifies the PTZ rotation speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_AUTO = 10;                           //The PTZ control is automatic. Ignore para1 and para2.
        public static final int PU_PTZ_PRESET_RUN = 11;                     //Rotate to a preset position. The para1 parameter indicates the preset position ID. Ignore para2.
        public static final int PU_PTZ_CRUISE_RUN = 12;                     //Rotate along the tour track. The para1 parameter indicates the tour track ID. Ignore para2.
        ...
        public static final int PU_PTZ_LENS_ZOOM_WIDE = 21;                 //Enlarge the field of view, that is, ZOOM OUT. The param1 parameter indicates the rotation mode. The value is fixed at 2, indicating the continuous mode. The param2 parameter indicates the speed.
        public static final int PU_PTZ_LENS_ZOOM_TELESCOPE = 22;            //Narrow the field of view, that is, ZOOM IN. The param1 parameter indicates the rotation mode. The value is fixed at 2, indicating the continuous mode. The param2 parameter indicates the speed.

        /*This parameter is not recommended in the new version.*/
        public static final int PU_PTZ_LENS_ZOOM_IN = 21;                   //(You are advised to use PU_PTZ_LENS_ZOOM_WIDE instead of this parameter in the new version.)
        public static final int PU_PTZ_LENS_ZOOM_OUT = 22;                  //(You are advised to use PU_PTZ_LENS_ZOOM_TELESCOPE instead of this parameter in the new version.)

        public static final int PU_PTZ_LENS_ZOOM_STOP = 23;                 //Stop zooming.
        public static final int PU_PTZ_LENS_FOCAL_NEAR = 24;                //Focus near. The param1 parameter indicates the rotation mode. The value is fixed at 2, indicating the continuous mode. The param2 parameter indicates the speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_LENS_FOCAL_FAR = 25;                 //Focus far. The param1 parameter indicates the rotation mode. The value is fixed at 2, indicating the continuous mode. The param2 parameter indicates the speed. The value ranges from 1 to 10.
        public static final int PU_PTZ_LENS_FOCAL_STOP = 26;                //Stop adjusting the focus.
        public static final int PU_PTZ_AUX_OPEN = 27;                       //The auxiliary device is enabled. para1 indicates the device name. Ignore para2.
        public static final int PU_PTZ_AUX_STOP = 28;                       //The auxiliary device is disabled. para1 indicates the device name. Ignore para2.
        public static final int PU_PTZ_HORIZONTAL_SCAN = 29;                //Horizontal scan. The para1 parameter indicates the direction, and para2 indicates the speed (range: 1-10).
        public static final int PU_PTZ_VERTICAL_SCAN = 30;                  //Vertical scan. Ignore para1. The para2 parameter indicates the speed (range: 1-10).
        ...
        public static final int PU_PTZ_MODE_CRUISE_START = 39;              //Pattern scan starts.The para1 parameter indicates the tour track ID. Ignore para2.
        public static final int PU_PTZ_MODE_CRUISE_STOP = 40;               //Pattern scan stops. The para1 parameter indicates the tour track ID. Ignore para2.
        public static final int PU_PTZ_FAST_MOVE = 41;                      //Select a point for quick positioning. The para1 parameter indicates the x coordinate, and the para2 parameter indicates the y coordinate.
        public static final int PU_PTZ_HORIZONTAL_LIMIT_SCAN = 51;          //Horizontal limit scan. The param1 parameter indicates the rotation mode. The value is fixed at 2, indicating the continuous mode. The param2 parameter indicates the speed. The value ranges from 1 to 10.
        ...
        public static final int PTZ_VERTICAL_LIMIT_SCAN = 55;               //Vertical limit scan. The param1 parameter indicates the rotation mode. The value is fixed at 2, indicating the continuous mode. The param2 parameter indicates the speed. The value ranges from 1 to 10.
    ...
    public interface PU_ALARM_TYPE {
        ...
        public static final int PU_ALARM_TYPE_SHIELD = 6;                       //Lens blocking alarm, including the intelligent lens blocking detection alarm.
        ...
        public static final int PU_ALARM_TYPE_FAN_PWR_BLOCKED = 38;         //The fan for the power module of a fixed dome camera is faulty.
        public static final int PU_ALARM_TYPE_FAN_HEC_BLOCKED = 39;              //The fan for the coding module of a fixed dome camera is faulty.
        ...
        public static final int PU_ALARM_TYPE_SFP_TX_PWR_HIGH = 46;              //Over-high transmission power alarm of the optical module.
        public static final int PU_ALARM_TYPE_SFP_TX_PWR_LOW = 47;               //Over-low transmission power alarm of the optical module.
        public static final int PU_ALARM_TYPE_SFP_RX_PWR_HIGH = 48;              //Over-high received power alarm of the optical module.
        public static final int PU_ALARM_TYPE_SFP_RX_PWR_LOW = 49;               //Over-low received power alarm of the optical module.
        ...
        public static final int PU_ALARM_TYPE_SFP_TEC_CURRENT_HIGH = 52;         //Over-high TEC current alarm of the optical module.
        public static final int PU_ALARM_TYPE_SFP_TEC_CURRENT_LOW = 53;          //Over-low TEC current alarm of the optical module.
        ...
        public static final int PU_ALARM_TYPE_ILLEGAL_PARKING = 123;                     //PTZ dome camera that supports parking violation detection.
        ...
        public static final int PU_ALARM_TYPE_HTTPS_CERT_WILL_EXPIRE = 301;       //Alarm of the HTTPS certificate about to expire.
        public static final int PU_ALARM_TYPE_DOT1X_CERT_EXPIRE = 302;            //802.1X certificate expiration alarm.
        public static final int PU_ALARM_TYPE_DOT1X_CERT_WILL_EXPIRE = 303;       //Alarm of the 802.1X certificate about to expire.
        ...
        public static final int PU_ALARM_TYPE_DOT1X_CA_CERT_WILL_EXPIRE = 312;    //Alarm of the 802.1X CA certificate about to expire.
        ...
        public static final int PU_ALARM_TYPE_VE_ON_VEHICLE_LANE = 401;           //Non-motor vehicles driving on motor vehicle lanes.
        public static final int PU_ALARM_TYPE_VE_ON_NONEVEHICLE_LANE = 402;       //Motor vehicles driving on non-motor vehicle lanes.
        ...
        //Abnormal license plate alarm (reserved).c type：PU_ALARM_TYPE_VE_ABNORMAL_PLATE
        public static final int PU_ALARM_TYPE_VE_REVERSE = 406;             //Illegal backing. Since the abnormal license plate is not deleted, the value is fixed at 406.
        //Master-slave camera surveillance (1+N).
        public static final int PU_ALARM_TYPE_SLAVE_RTSP_KEEP_ALIVE_FAIL = 500; //Alarm of the RTSP keepalive operation failure of the slave device.
    ...
    public interface PU_ENCRYPT_TYPE {
        public static final int PU_ENCRYPT_TYPE_HUAWEI_VIDEO = 0;          //Uses Huawei stream encryption algorithm to encrypt video.
        public static final int PU_ENCRYPT_TYPE_HUAWEI_AUDIO = 1;              //Uses Huawei stream encryption algorithm to encrypt audio.
        public static final int PU_ENCRYPT_TYPE_HUAWEI_MUX = 2;                //Uses Huawei stream encryption algorithm to encrypt hybrid streams.
    ...
    public interface PU_DSCP_TYPE {
        public static final int PU_DSCP_TYPE_MEDIA = 0;                 //Media differentiated services code point (DSCP) value (the media include audio and video).
    ...
    public interface PU_IGT_OPT_TYPE {
        public static final int PU_IGT_OPT_TYPE_ADD = 0;                //New: All information containing LPPU_IGT_TW_LINE_S or LPPU_IGT_AREA_S
        public static final int PU_IGT_OPT_TYPE_MOD = 1;                //Modified: All information containing LPPU_IGT_TW_LINE_S or LPPU_IGT_AREA_S
        public static final int PU_IGT_OPT_TYPE_DEL = 2;                //Deleted: Only the channelid and index with LPPU_IGT_TW_LINE_S or LPPU_IGT_AREA_S
        public static final int PU_IGT_OPT_TYPE_MOV = 3;                /*Move to the view when you want to add a tripwire or area. Only the channelid and index with LPPU_IGT_TW_LINE_S or LPPU_IGT_AREA_S*/
        /*The tripwire or coordinate information will be returned as an output parameter.*/
    ...
    public interface PU_ITGT_TYPE {
        ...
        //PU_ITGT_TYPE_NON_CHINA_VEH_RECOGTION, // Non-Chinese license plate recognition (incorporated).
        public static final int PU_ITGT_TYPE_VLPR_VEH_RECOGTION = 6;              //License plate recognition, incorporating non-Chinese license plate recognition and Chinese and Indonesian license plate recognition.
        ...
        public static final int PU_ITGT_TYPE_CHINA_INDO_VEH_RECOGTION = 14;        //Chinese and Indonesian license plate recognition (incorporated).
    ...
    public interface PU_CAM_WB_MODE {
        ...
        public static final int PU_WB_MODE_ATW = 1;                      //Automatic tracking (area where the white balance difference is large).
    ...
    public interface PU_VIDEO_WD_MODE {
        ...
        public static final int PU_WD_MODE_RATIOFIX = 5;                //The short exposure shutter speed is fixed. Set the ratio to determine the long exposure.
        public static final int PU_WD_MODE_HISTOGRAM = 6;               //Use the histogram to correct the over-bright and over-dark areas.
    ...
    public interface PU_IRC_TRIGGER_MODE {
        ...
        public static final int PU_IRC_LUM_TRIGGER = 1;           //Triggered by photosensitive sensor, which is the default trigger mode.
    ...
    public interface PU_FTP_UPLOAD_FIRST_DIR_TYPE {
        public static final int PU_FTP_UPLOAD_FIRST_DIR_TYPE_IP = 0;   //The level-1 directory is named by device IP address.
    ...
    public interface PU_FTP_UPLOAD_SECOND_DIR_TYPE {
        public static final int PU_FTP_UPLOAD_SECOND_DIR_TYPE_CHANNEL = 0; //The level-2 directory is named by channel ID.
    ...
    public interface PU_ONVIF_AUTH_TYPE {
        ...
        public static final int AUTH_TYPE_DIGGEST_AND_WSSE = 1;    //Digest authentication and WSSE authentication are supported. Digest authentication takes precedence over WSSE authentication.
    ...
    public interface PU_VLPR_CATCH_MODE {
        ...
        public static final int PU_VLPR_MODE_COEXISTED = 1;       //Motor vehicle, non-motor vehicle, and pedestrian detection mode.
    }
    ...
    public interface BACKLIGHT_MODE {
        ...
        public static final int VIDEO_MODE_UP = 2;              //The backlight area is the upper part of the image (this variable is reserved).
        public static final int VIDEO_MODE_DOWN = 3;            //The backlight area is the lower part of the image (this variable is reserved).
        public static final int VIDEO_MODE_LEFT = 4;            //The backlight area is the left part of the image (this variable is reserved).
        public static final int VIDEO_MODE_RIGHT = 5;           //The backlight area is the right part of the image (this variable is reserved).
    ...
    public interface PU_ALARM_LINK_PTZ_PRIORITY {
        public static final int PU_GUARD_FIRST = 0; //Park action first. (When the park waiting time elapses, the park action is triggered no matter whether any alarm is generated.)
        public static final int PU_ALARM_FIRST = 1;     //Alarm linkage first. (During the alarming period, the park action does not take effect.)
    ...
    public interface LAYER_THREE_TYPE_E {
        ...
        public static final int FACE_PIC_TZONE = 0x08000020; //Time zone of the face cutout device, in milliseconds. + indicates an eastern time zone, and - indicates a western time zone.
        ...
        public static final int FACELIB_RECORDID = 0x07000017; //Face ID in the face library, which is used to maintain the consistency of feature records.
        public static final int FACE_MATCHRATE = 0x07000020; //Face match rate.
        public static final int FACE_INFO = 0x12000001; //Face information, corresponding to the information in the database.
        ...
        public static final int TARGET_TYPE = 0x07000023; //Object type, which is used to differentiate face cutout, facial recognition, and facial recognition in multi-camera collaboration mode.
        public static final int FACE_LIB_ID = 0x07000024; //Face library ID.
        public static final int MMC_FACE_COMPARE_NUM_MAX = 0x07000025; //Multi-camera collaboration algorithm parameter (face match data).
        public static final int MMC_FACE_WARNING_RECALL_RATE_MAX = 0x07000026; //Multi-camera collaboration algorithm parameter (maximum face alarm recall rate).
        public static final int MMC_FACE_WARNING_RECALL_RATE_MIN = 0x07000027; //Multi-camera collaboration algorithm parameter (minimum face alarm recall rate).
        ...
        public static final int PIC_SNAPSHOT_TZONE = 0x08000069; //Time zone of the device, in milliseconds. + indicates an eastern time zone, and - indicates a western time zone.
        ...
        public static final int VEHICLE_TL_X = 0x0400002A; //X coordinate of the upper left corner of the vehicle position.
        public static final int VEHICLE_TL_Y = 0x0400002B; //Y coordinate of the upper left corner of the vehicle position.
        public static final int VEHICLE_BR_X = 0x0400002C; //X coordinate of the lower right corner of the vehicle position.
        public static final int VEHICLE_BR_Y = 0x0400002D; //Y coordinate of the lower right corner of the vehicle position.
        public static final int PLATE_TL_X = 0x0400002E; //X coordinate of the upper left corner of the license plate position.
        public static final int PLATE_TL_Y = 0x0400002F; //Y coordinate of the upper left corner of the license plate position.
        public static final int PLATE_BR_X = 0x04000030; //X coordinate of the lower right corner of the license plate position.
        public static final int PLATE_BR_Y = 0x04000031; //Y coordinate of the lower right corner of the license plate position.
        public static final int MICRO_PORT_TRAFFIC_STATISTICS = 0x070000A0;//Traffic flow statistics parameter.
        public static final int MICRO_PORT_TRAFFIC_STATISTICS_LANE_COUNT = 0x070000A1;//Number of lanes for vehicle traffic statistics of the micro checkpoint camera.
        public static final int MICRO_PORT_TRAFFIC_STATISTICS_LANE_INDEX = 0x070000A2;//Current lane for vehicle traffic statistics of the micro checkpoint camera.
        ...
        public static final int MICRO_PORT_TRAFFIC_STATISTICS_VEHICLE_TYPE1_COUNT = 0x070000AA;//Number of large vehicles.
        public static final int MICRO_PORT_TRAFFIC_STATISTICS_VEHICLE_TYPE2_COUNT = 0x070000AB;//Number of medium vehicles.
        public static final int MICRO_PORT_TRAFFIC_STATISTICS_VEHICLE_TYPE3_COUNT = 0x070000AC;//Number of small vehicles.
        ...
        public static final int ITS_TRAFFIC_STRAIGHT_VHEICLE_COUNT = 0x070000B0; //Number of straight-through vehicles (ITS).
        ...
        public static final int ITS_VEHICLE_FLOWRATE_FEATURE = 0x0700009A; //Vehicle traffic statistics attribute (ITS).
        ...
        public static final int VHD_OBJ_ID = 0x09000006; //Object (motor vehicle, non-motor vehicle, and pedestrian) ID.
        ...
        public static final int PEOPLE_NUM = 0X07000087; //Number of persons returned by the crowd density detection algorithm.
        public static final int HEADSHOULDER_POS = 0X0B000088; //Frame position returned by the crowd density detection algorithm.
        public static final int AREARATIO = 0X07000089; //Crowd density returned by the crowd density detection algorithm.
        ...
        public static final int RIDERMAN_UPPERCOLOR = 0X07000403; //Tops color (black, blue, green, white/gray, yellow/orange/brown, red/pink/purple).
    ...
    public interface PU_FACE_PACKET_TYPE {
        ...
        public static final int FACE_PACKET_TYPE_FEATUREMODE = 1;        //Facial features only; SDK mode only; must be used with the platform.
        public static final int FACE_PACKET_TYPE_ALLPACKET = 2;           //Entire package (image + personnel information + facial features).
    ...
    public static class PU_CERT_FILE_PATH_PARA_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList(
                    "szCACertFilePath", "szKeyFilePath", "szCertFilePath", "szKeyPasswd", "szReserve");
        }
    }
    ...
    public static class PU_REAL_PLAY_INFO_V20_S extends Structure {
        ...
        public int enMediaCallbackType; //Callback type. 0: RTP decryption; 1: no RTP decryption; 2: frame; 3: YUV.PU_MEDIA_CALLBACK_TYPE_E
        ...
        public byte[] szMulticastIP = new byte[PU_IP6_ADDR_LEN];//Multicast IP address (This parameter is required for multicast streams.)

        public NativeLong ulMulticastPort; //Multicast port (This parameter is required for multicast streams.)

        public byte[] szReserved = new byte[PU_RESERVE_LEN]; //szReserved[22] indicates the packaging format of the intelligent analysis data. The value 0 indicates XML, and the value 1 indicates metadata.


        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "hPlayWnd", "enStreamType", "enVideoType",
                    "enProtocolType", "enMediaCallbackType", "szLocalIp", "bKeepLive",
                    "stStartTime", "stEndTime", "enIGTDataType", "szMulticastIP", "ulMulticastPort", "szReserved");
        }
    }
    ...
    public static class PU_SNAPSHOT_LIST_S extends Structure {
        ...
        public PU_IMAGE_INFO_LIST_S[] szImageInfoList = (PU_IMAGE_INFO_LIST_S[]) new PU_IMAGE_INFO_LIST_S().toArray(PU_SNAPSHOT_INQUIRE_NUM); //Image information.
    ...
    public static class PU_IMAGE_INFO_LIST_S extends Structure {
        ...
        public PU_ASSOCIATE_RECORD_INFO_S stRecordInfo;    //Associated recording information (valid only for ePolice devices when a violation type is specified by IVS_PU_GetITSSnapshotPicList).
    ...
    public static class PU_DAYLIGHT_SAVING_TIME_S extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("enDSTType", "bEnable", "enOffset", "stDSTStartTime", "stDSTEndTime", "enDateWayOffset", "szReserved");
        }
    }
    ...
    public static class PU_DST_WEEK_WAY_S extends Structure {
        ...
        public WinDef.UINT uiMonth;                               //Month in a year. The value ranges from 0 to 11, indicating January to December.

        public WinDef.UINT uiWeek;                                //Week in a month. The options are as follows: 0: first week; 1: second week, 2: third week; 3: fourth week; 4: last week.
    ...
    public static class PU_DST_DATE_WAY_S extends Structure {
        ...
        public WinDef.UINT uiYear;                                //The value 0 indicates every year, and [2014,2024] indicates the corresponding years.

        public WinDef.UINT uiMonth;                               //Month in a year. The value ranges from 0 to 11, indicating January to December.

        public WinDef.UINT uiDay;                                 //Day in a month. The value ranges from 0 to 30, indicating the first day to the last day in a month.
    ...
    public static class LPPU_DEVICEINFO_S extends Structure {
        ...
        public byte[] szDeviceName = new byte[PU_DEVICE_NAME_LEN];    //Device name. The device name can contain a maximum of 32 characters.

        public byte[] szDeviceFac = new byte[PU_FAC_NAME_LEN];        //Device vendor.

        public byte[] szDeviceType = new byte[PU_DEVICE_TYPE_LEN];    //Device model, which can be queried but cannot be set.
    ...
    public static class PU_DEVICE_VERSION extends Structure {
        ...
        //szReserved[24]: input parameter, indicating the network port index. The value 0 indicates network adapter 1. The value 1 indicates network adapter 2.
    ...
    public static class LPPU_UPGRADE_FILE_INFO_S extends Structure {
        ...
        public byte[] cFileNum = new byte[PU_UPGRADE_FILE_NUM_MAX];                                                          //Number of files. The maximum number of files is UPGRADE_FILE_NUM_MAX.

        public byte[][] szFileName = new byte[PU_UPGRADE_FILE_NUM_MAX][PU_UPGRADE_FILE_LEN_MAX];    //File path and file name. The first one is uImage, the second one is jffs2, and the third and fourth are reserved for extension.
    ...
    //Upgrade callback data structure. Currently, only the transferred file size and total file size are included.
    ...
    public static class PU_1TN_SUPPORT_MODE_LIST_S extends Structure {
        ...
        public int[] enSpptModelist = new int[PU_1TN_SUPPORT_MODE.TN_ITGT_SUPPORT_MODE_MAX];//List of intelligent capabilities supported by 1+N devices.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_MASTER_SLAVER_CHANNEL_INFO_S extends Structure {
        ...
        public WinDef.ULONG ulSlaveChanCap;   //Slave channel capability, that is, the maximum number of supported slave channels.
        public WinDef.ULONG ulMasterChanNum;  //Number of master channels.
        public WinDef.ULONG ulSlaveChanNum;   //Number of slave channels.
        public PU_PRE_CHANNEL_INFO_S[] astMasterChanInfo = (PU_PRE_CHANNEL_INFO_S[]) new PU_PRE_CHANNEL_INFO_S().toArray(PU_MASTER_NUM_MAX);  //Master channel information.
        public PU_PRE_CHANNEL_INFO_S[] astSlaveChanInfo = (PU_PRE_CHANNEL_INFO_S[]) new PU_PRE_CHANNEL_INFO_S().toArray(PU_SLAVE_NUM_MAX);    //Slave channel information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SLAVE_DEVICE_LIST_S extends Structure {
        public PU_SLAVE_DEVICE_INFO_S[] astSlaveInfo = (PU_SLAVE_DEVICE_INFO_S[]) new PU_SLAVE_DEVICE_INFO_S().toArray(PU_SLAVE_NUM_MAX); //Slave camera list.
    ...
    public static class PU_SLAVE_DEVICE_INFO_S extends Structure {
        ...
        public byte[] szSlaveName = new byte[PU_CLIENT_USERNAME_LEN];  //Name of the slave camera, which cannot exceed 32 characters.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SLAVE_ONVIF_LIST extends Structure {
        public PU_SLAVE_ONVIF_PARAM_S[] astOnvifClient = (PU_SLAVE_ONVIF_PARAM_S[]) new PU_SLAVE_ONVIF_PARAM_S().toArray(PU_SLAVE_NUM_MAX);   //onvif parameter
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SLAVE_RTSP_LIST_S extends Structure {
        public PU_SLAVE_RTSP_PARAM_S[] astRtspClient = (PU_SLAVE_RTSP_PARAM_S[]) new PU_SLAVE_RTSP_PARAM_S().toArray(PU_SLAVE_NUM_MAX);  //rtsp parameters
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SLAVE_RTSP_PARAM_S extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulSlaveID", "bEnable", "ulChannelId", "ulRtspPort", "szUserName", "szPassWord", "szReserved");
        }
    }
    ...
    public static class PU_HUMANCOUNT_TABLE extends Structure {
        ...
        public int enInDir;                        //Entering direction. (The clockwise direction is regarded as enter, and the counterclockwise direction is regarded as exit.)
        public WinDef.ULONG ulRecordNum;                    //Number of records to query.
        public PU_HUMANCOUT_RECORD[] astTable = (PU_HUMANCOUT_RECORD[]) new PU_HUMANCOUT_RECORD().toArray(32);  //Table displaying the head count statistics in each time segment.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public interface PU_SLAVE_ONVIF_STATUS_TYPE {
        ...
        int SLAVE_ONVIF_STATUS_MEDIA_ENCODING_INAPPROPRIATE = 5; //The encoding mode does not comply with the MEDIA mode.
        int SLAVE_ONVIF_STATUS_MEDIA2_ENCODING_INAPPROPRIATE = 6;//The encoding mode does not comply with the MEDIA2 mode.
    ...
    public interface PU_1TN_SUPPORT_MODE {
        ...
        public int TN_FACE_OR_VHD_TWO_SUPPORT_MODE = 5;        //2-channel object classification/face checkpoint (any combinations).
        public int TN_FACE_OR_VHD_THREE_SUPPORT_MODE = 6;        //3-channel object classification/face checkpoint (any combinations).
        ...
        public int TN_FACE_TWO_VHD_TWO_SUPPORT_MODE = 9;        //2-channel object classification + 2-channel face checkpoint + 1-channel recognition.
    ...
    public static class PU_DISCOVER_DEVICE_INFO_S extends Structure {
        ...
        public WinDef.UINT uDhcpEnable;                         //Indicates whether to enable DHCP. The options are as follows: 0: no; 1: yes; 2 (for compatibility with earlier version): unknown.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];          //Reserved.
    ...
    public static class PU_DEVICE_ETHERNET_PARA extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];           //szReserved[0]: network port index. The value 0 indicates network adapter 1. The value 1 indicates network adapter 2.
    ...
    public static class PU_SNMPV3_USER_INFO extends Structure {
        ...
        public WinDef.BOOL bEngineIdEnable;                            //Indicates whether to specify the ENGINEID (used only when Trap is configured).
        public byte[] szEngineId = new byte[PU_SNMP_ENGINEID_LEN];           //ENGINEID (used only when Trap is configured).
        public WinDef.BOOL bContextEnable;                             //Indicates whether to specify the context name (used only when Trap is configured).
        public byte[] szContextName = new byte[PU_SNMP_CONTEXT_NAME_LEN];    //Context name (used only when Trap is configured).
        public byte[] szAuthPassword = new byte[PU_PASSWORD_LEN];            //Authentication password. If the authentication password is configured on the web page, the password is delivered in the original text. If the authentication password is recorded in the configuration file, the authentication password is in cipher text.
        public byte[] szPrivKey = new byte[PU_PASSWORD_LEN];                 //Private key. If the private key is configured on the web page, the private key is delivered in the original text. If the private key is recorded in the configuration file, the private key is in cipher text.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("szUserName", "bEngineIdEnable", "szEngineId", "bContextEnable", "szAuthPassword", "szPrivKey", "enSecurityLevel", "enAuthProtocol", "enPrivProtocol");
        }
    }
    ...
    public static class PU_SNMPV3_USER_MGMT extends Structure {
        ...
        public byte[] szModifyVerifyPwd = new byte[PU_PASSWORD_LEN];             //Authentication password of the current SNMP user (the security level is not noauth).
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_IGT_TW_LINE extends Structure {
        ...
        public WinDef.UCHAR ucDirection;                      /*Detection direction. 0: both; 1: from left to right; 2: from right to left.*/
    ...
    public static class PU_IPFILTER_RULES_INFO extends Structure {
        ...
        public int enIpFilterStrategy;                     //IP address filtering policy: whitelist or blacklist. c type:PU_IP_FILTER_STRATEGY
        public NativeLong ulIpFilterRulesNum;                                       //IP address filtering rule item.
        public PU_IPFILTER_RULES[] stIpFilterRulesList = new PU_IPFILTER_RULES[PU_IP_FILTER_NUM_MAX];  //IP address filtering rule list.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_IPFILTER_RULES extends Structure {
        ...
        public byte[] szIPAddress = new byte[PU_IP4_ADDR_LEN];                         //IP address by which data packets are to be filtered out.
        public byte[] szSubNetAddress = new byte[PU_IP4_ADDR_LEN];                     //Subnet mask by which data packets are to be filtered out.
    ...
    public static class PU_IPFILTER_RULESV2 extends Structure {
        ...
        public NativeLong ulIpEndPort;                                         //End port by which data packets are to be filtered out.
        public int enProtocolType;                      //Protocol by which data packets are to be filtered out.
        public byte[] szMACAddress = new byte[PU_HEX_MAC_ADDR_LEN + 1];                    //MAC address by which data packets are to be filtered out.
        public WinDef.BOOL bStatus;                                              //Data packet filtering rule status, effective or not effective.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];                            //szReserve[0] indicates the applied network adapter. The value 0 indicates network adapter 1. The value 1 indicates network adapter 2. The rest can be deducted by analogy.
    ...
    public static class PU_IPFILTER_RULES_INFOV2 extends Structure {
        ...
        public PU_IPFILTER_RULESV2[] stIpFilterRulesList = new PU_IPFILTER_RULESV2[PU_IP_FILTER_NUM_MAXV2];  //IP address filtering rule list.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_IPFILTER_RULES_INFOV3_S extends Structure {
        ...
        public int enIpFilterStrategy;                     //IP address filtering policy: whitelist or blacklist. c type:PU_IP_FILTER_STRATEGY
        public NativeLong ulIpFilterRulesNum;                                       //IP address filtering rule item.
        public PU_IPFILTER_RULESV2[] stIpFilterRulesList = new PU_IPFILTER_RULESV2[PU_IP_FILTER_NUM_MAXV3];  //IP address filtering rule list.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_USER_INFO extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                      //szReserved[0] indicates the maximum number of users allowed to simultaneously log in to the web system. The value ranges from 1 to 10.
    ...
    public static class PU_STREAMPROFILES_INFO_LIST extends Structure {
        ...
        public PU_STREAMPROFILES_INFO[] szStreamProfile = (PU_STREAMPROFILES_INFO[]) new PU_STREAMPROFILES_INFO().toArray(STREAM_PROFILES_MAX);          //Information list.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                                          //Reserved.
    ...
    public static class PU_STREAM_PROFILES_PARA extends Structure {
        ...
        public ULONG ulIndex;                                           //Unique ID. The digits 1-4 indicate basic settings and cannot be deleted. The value 0 indicates automatic adaptation.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulIndex", "szName", "szDescrip", "stV4ideoEncodePara", "stAudioInfo", "bAiVqeStatus", "bCorridorEnable", "szReserve");
        }
    ...
    public static class PU_VIDEO_ENCODE_PARA extends Structure {
        ...
        public PU_STREAM_ATTRIBUTE[] stStreamAttribute = (PU_STREAM_ATTRIBUTE[]) new PU_STREAM_ATTRIBUTE().toArray(PU_ENC_STREAM_MAX_NUM); //Video attribute.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];//szReserved[0] indicates the narrow or wide screen mode. The options are as follows: 0: wide screen; 1: narrow screen.
    ...
    public static class PU_STREAM_ATTRIBUTE extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("enStreamId", "stVideoAttribute", "ulFrameRate", "enVideoEncodeMode", "enResolution", "enBitRateType", "enPicQuality", "enVideoFormat", "enRcPriMode", "enMirrorMode", "szReserve");
        }
    }
    ...
    public static class PU_VIDEO_ATTRIBUTE extends Structure {
        ...
        public byte[] szReserve = new byte[PU_RESERVE_LEN];           //szReserve[0] indicates the encoding complexity. H264: 0: BP, 1: MP, 2: HP;
        //H265: 0: Main, 1: Main10, 2: MainSP (Currently, only Main is supported.).
        //szReserve[1] indicates the MJPEG quality value [2,99].
        //szReserve[2] indicates whether to enable layered encoding. 0: disable; 1: enable (valid only when setting or obtaining stream profiles).
        //szReserve[3] indicates the intelligent encoding level. The value 0 indicates that intelligent encoding is disabled. The value 1-5 indicates levels 1 to 5.
        //szReserve[4] indicates whether to enable multi-slice encoding. 0: disable; 1: enable.
    ...
    public static class PU_AUDIO_INFO extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                 //SzReserved[0]: sampling rate. The options are as follows: 0 (8 kHz), 1 (12 kHz), 2 (16 kHz), 3 (24 kHz), 4 (48 kHz), 5 (22.05 kHz), 6 (32 kHz), and 7 (44.1 kHz).

        //szReserved[1]: audio input port type. The options are 0 (LINE IN) and 1 (MIC IN).
        //szReserved[2]: indicates whether to enable automatic audio gain. The options are 0 (no) and 1 (yes).
        @Override
        protected List<String> getFieldOrder() {
    ...
    public static class PU_VIDEO_ENCODE_PARAV2 extends Structure {
        ...
        public PU_STREAM_ATTRIBUTE[] stStreamAttribute = (PU_STREAM_ATTRIBUTE[]) new PU_STREAM_ATTRIBUTE().toArray(PU_ENC_STREAM_MAX_NUM_V2); //Video attribute.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];                                 //szReserved[0] indicates the narrow or wide screen mode. The options are as follows: 0: wide screen; 1: narrow screen.
    ...
    public static class PU_ALARM_TIME_PARA_LIST extends Structure {
        ...
        public PU_ALARM_TIME[] stAlarmTime = (PU_ALARM_TIME[]) new PU_ALARM_TIME().toArray(PU_ALARM_TIME_MAX);                 //Alert deployment time segment array.
    ...
    public static class SMTP_CONFIG_INFO extends Structure {
        public int enMailType;    //Indicates whether the email is a parameter delivery email or a test email. The options are as follows: 0: test; 1: parameter delivery.
        ...
        public PU_SMTP_RECVEIVER_INFO[] szReceiverInfo = (PU_SMTP_RECVEIVER_INFO[]) new PU_SMTP_RECVEIVER_INFO().toArray(PU_SMTP_RECV_MAX_NUM);         //Recipient list.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("enMailType", "bSMTPEnable", "szSenderName", "szSenderMail", "szServerIP", "ulServerPort", "enSecurityType",
                    "bPicEnable", "ulPicNum", "ulSnapTimeInterval", "bServerCrtEnable", "szServerName", "szPassword", "ulReceiverNum", "szReceiverInfo", "szReserved");
        }
    }
    ...
    public static class ONVIF_RTSP_SESSION_TIMEOUT extends Structure {
        ...
        public int enStreamId;       //Code stream type (primary stream, secondary stream 1, secondary stream 2). c type:PU_STREAM_TYPE
    ...
    public static class PU_H264_DEC_ATTR extends Structure {
        public int uPictureFormat;       //Output image format. The options are 0x00 (YUV420), 0x01 (YUV422), and 0x02 (YUV444).
    ...
    public static class PU_H264_DEC_FRAME extends Structure {
        ...
        public int uPicFlag;             //Output image attribute. The options are as follows: 0: frame; 1: top field; 2: bottom field.
        public int uError;               //Indicates whether an error occurs on the output image. The options are as follows: 0: no; 1: yes.
        public int uIntra;               //Indicates whether the output image is an IDR frame. The options are as follows: 0: no; 1: yes.
    ...
    public static class PU_H265D_INIT_PARAM extends Structure {
        ...
        public int enThreadType; //Thread type. TODO: Currently, multiple threads are not supported. The partitioning modes of multiple threads, such as by tile, slice, and LCU line, will be added.
        public int enOutputOrder;//Output sequence. TODO: This parameter is valid only for DecodeFrame but not for DecodeAU.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("uiChannelID", "iMaxWidth", "iMaxHeight", "iMaxRefNum", "enThreadType", "enOutputOrder", "pstUserData", "MallocFxn", "FreeFxn", "LogFxn");
        }
    }
    ...
    public interface PU_H265D_DECODEMODE {
        ...
        public static final int PU_H265D_DECODE_END = 1;       //Decoding is complete, and the decoder is required to output the remaining images.
    }
    ...
    public static class PU_H265DEC_OUTARGS extends Structure {
        ...
        public int uiSarWidth;                  //Width of the aspect ratio. This parameter is valid only when uiAspectRatioIdc is set to 255.
        public int uiSarHeight;                 //Height of the aspect ratio. This parameter is valid only when uiAspectRatioIdc is set to 255.
        public int uiVpsNumUnitsInTick;         //Frame rate information.
        public int uiVpsTimeScale;              //Frame rate information.
        public PU_CU_OUTPUT_INFO stCuOutInfo;  //Output the current frame information, including the number of CUs of various types in a frame.
        public int iIsError;                     //Indicates whether an error occurs on the frame. The options are as follows: 0: no; 1: yes.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("uiChannelID", "uiBytsConsumed", "uiTimeStamp", "enFrameType", "enDecodeStatus", "uiDecWidth", "uiDecHeight", "uiYStride",
                    "uiUVStride", "pucOutYUV", "uiCodingBytesOfCurFrm", "stUserData", "uiAspectRatioIdc", "uiSarWidth", "uiSarHeight", "uiVpsNumUnitsInTick", "uiVpsTimeScale", "stCuOutInfo", "iIsError");
        }
    }
    ...
    public interface PU_H265D_DECODESTATUS {
        public static final int PU_H265_DEC_GETDISPLAY = 0; //One frame has been decoded and output, and can be used for display.
        public static final int PU_H265_DEC_NEED_MORE_BITS = 1; //The decoder has no image output and requires more streams.
    ...
    public static class PU_CU_OUTPUT_INFO extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("uiCuNumIntra4", "uiCuNumIntra8", "uiCuNumIntra16", "uiCuNumIntra32", "uiCuNumIntra64", "uiCuNumPcm4", "uiCuNumPcm8", "uiCuNumPcm16", "uiCuNumPcm32", "uiCuNumPcm64", "uiCuNumInter8",
                    "uiCuNumInter16", "uiCuNumInter32", "uiCuNumInter64", "uiCuNumSkip8", "uiCuNumSkip16", "uiCuNumSkip32", "uiCuNumSkip64");
        }
    }
    ...
    public static class PU_VIDEO_STREAM_INFO extends Structure {
        ...
        public PU_STREAM_ATTRIBUTE[] stStreamAttribute = (PU_STREAM_ATTRIBUTE[]) new PU_STREAM_ATTRIBUTE().toArray(PU_STREAM_MODE_E.PU_VIEDO_STREAM_TRIPLE);//Video attribute.
    ...
    public static class PU_VIDEO_STREAM_INFO_V2 extends Structure {
        public ULONG ulChannelId;                                              //Channel ID.
        public int enStreamMode;                                  //Video stream type. PU_VIDEO_TYPE
        public PU_STREAM_ATTRIBUTE[] stStreamAttribute = (PU_STREAM_ATTRIBUTE[]) new PU_STREAM_ATTRIBUTE().toArray(PU_STREAM_MODE_E.PU_VIEDO_STREAM_FIVE);//Video attribute.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                                //szReserve[0] indicates the full frame rate. 25: 25 fps; 30: 30 fps; 50: 50 fps; 60: 60 fps.
        //szReserve[1] indicates the narrow or wide screen. 0: wide screen; 1: narrow screen.
    ...
    public static class PU_VIDEO_DISPLAY_INFO extends Structure {
        ...
        public ULONG ulBitMap;                            //Modify bit. The five bits (for example, 00000) indicate the sharpness, hue, saturation, contrast, and brightness from the lowest bit to the highest bit respectively. The value 1 indicates modification. The value 0 indicates no modification.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "lBrightValue", "lHueValue", "lSaturationValue", "lContrastValue", "lSharpValue", "enSharpSwitch", "ulBitMap", "ulBitMap");
        }
    }
    ...
    public static class PU_ROI_INFO extends Structure {
        ...
        public PU_ROI_AREA_INFO[] stROIAreaInfo = (PU_ROI_AREA_INFO[]) new PU_ROI_AREA_INFO().toArray(PU_ROI_AREA_NUM_MAX);             //ROI rectangle parameters.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_OSD_STRING_ARRAY extends Structure {
        ...
        public PU_OSD_STRING_PARA[] szStringPara = (PU_OSD_STRING_PARA[]) new PU_OSD_STRING_PARA().toArray(PU_OSD_STRING_NUM);           //OSD character string parameters.
    ...
    public static class PU_OSD_DATETIME_PARA extends Structure {
        ...
        public int enLanguageType;      //OSD language. The options are as follows: 0: simplified Chinese; 1: English. C type:PU_LANGUAGE_TYPE_E
    ...
    public static class PU_OSD_INFO extends Structure {
        ...
        public byte[] szReserve = new byte[PU_RESERVE_LEN];         //Bit [0] indicates whether the color is inverted (0: no; 1: yes).
    ...
    public static class PU_OSD_MARGIN_INFO extends Structure {
        public ULONG ulChnID;
        public ULONG ulDirect;                        //OSD margin direction. The options are as follows: 0: upward; 1: downward; 2: leftward; 3: rightward.
        public WinDef.BOOL bEnable;
    ...
    public static class PU_OSDI_BUSINESS_PARA extends Structure {
        ...
        public PU_OSDI_AREA_CFG_PARA[] stOSDIAreaPara = (PU_OSDI_AREA_CFG_PARA[]) new PU_OSDI_AREA_CFG_PARA().toArray(OSDI_AREA_NUM_MAX);  //OSDI area information.
    ...
    public static class PU_OSDI_BUSINESS_PARA_V20 extends Structure {
        ...
        public WinDef.BOOL bOSDIEnable;                                           //Indicates whether to enable the OSDI function.
        public ULONG ulOSDINum;                                            //Current number of OSDI areas.
        public PU_OSDI_AREA_CFG_PARA_V20[] stOSDIAreaPara = (PU_OSDI_AREA_CFG_PARA_V20[]) new PU_OSDI_AREA_CFG_PARA_V20().toArray(OSDI_AREA_NUM_MAX);  //OSDI area information.
    ...
    public static class PU_PRIVACY_MASK_AREA_ARRAY extends Structure {
        ...
        public ULONG ulNum;
        public WinDef.BOOL bEnable;
        public PU_MASK_AREA_PARA[] stMaskParaEx = (PU_MASK_AREA_PARA[]) new PU_MASK_AREA_PARA().toArray(PU_PRIVACY_MASK_MAX);
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_PRIVACY_MASK_AREA_LIST extends Structure {
        ...
        public WinDef.BOOL bEnable;
        public PU_MASK_AREA_PARA_V20[] stMaskPara = (PU_MASK_AREA_PARA_V20[]) new PU_MASK_AREA_PARA_V20().toArray(PU_PRIVACY_MASK_MAX);
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_PLATFORM_GBT_PARA extends Structure {
        ...
        //szReserve[1]: input parameter, indicating the platform type. The options are as follows: 0: GB/T 28181-1, 1: GB/T 28181-2.
    ...
    public static class PU_DYNAMIC_STREAM_INFO extends Structure {
        ...
        public ULONG ulDynamicBitRate;                 //VBR.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];        //szReserved[0] indicates whether to enable dynamic frame rate.
    ...
    public static class PU_RECORD_PLAN extends Structure {
        ...
        public PU_TIME_PLAN[] szRecordPlanList = (PU_TIME_PLAN[]) new PU_TIME_PLAN().toArray(PU_RECORD_PLAN_NUM);            //Recording plan list.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_TIME_PLAN extends Structure {
        public ULONG ulCycle;                          //Cycle control. The options are as follows: 0: one-time; 1: in the specified time segment every week.
    ...
    public static class PU_RECORD_LIST extends Structure {
        ...
        public ULONG ulBeginIndex;
        public ULONG ulEndIndex;
        public PU_RECORD_INFO[] szRecordInfoList = (PU_RECORD_INFO[]) new PU_RECORD_INFO().toArray(PU_RECORD_INFO_NUM_MAX);
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ALARM_REC_INQ_RSP extends Structure {
        ...
        public PU_ALARM_REC_INFO[] astAlarmRecInfoList = (PU_ALARM_REC_INFO[]) new PU_ALARM_REC_INFO().toArray(PU_RECORD_INFO_NUM_MAX);    //Alarm-triggered recording list.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class RECORD_STRATEGY extends Structure {
        public ULONG ulChannelId;
        public ULONG ulStrategy;                       //Storage policy. The options are as follows: 0: Overwrite the earliest recording; 1: Stop recording.
        public ULONG ulMinRecordTime;                  //Minimum pre-recording time.
        public ULONG ulPreAlarmRecordTime;             //Pre-recording time. V200R003: 0: no pre-recording; 65535: maximum pre-recording duration based on the memory capability; 5s to 20s based on the device capability.
    ...
    public static class PU_DEVICE_ABILITY extends Structure {
        ...
        public ULONG ulRTPOverFlag;                    //Transmission protocol. The options are as follows: 0: RTP over UDP; 1: RTP over TCP; 2: RTP over UDP&TCP.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulVideoInputChannelNum", "ulAudioInputChannelNum", "ulAlarmDINum", "ulAlarmDONum", "ulSerialPortNum", "ulNetworkCardNum",
                    "ulHardDiskNum", "ulPTZNum", "ulTalkbackInputNum", "ulTalkbackOutputNum", "ulRTPOverFlag", "stHardDiskInfo", "szReserved");
        }
    }
    ...
    public static class PU_STREAM_ABILITY extends Structure {
        ...
        public PU_STREAM_ABILITY_PARA[] stStreamAbility = (PU_STREAM_ABILITY_PARA[]) new PU_STREAM_ABILITY_PARA().toArray(PU_STREAM_NUM);
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "szCameraName", "ulPTZType", "ulPresetNum", "ulCruiseTrackNum", "ulMaxStreamNum", "bPtzFastLocate",
                    "bPtzHorizotalScan", "bPtzVerticalScan", "stStreamAbility", "szReserved");
        }
    }
    ...
    public static class PU_STREAM_ABILITYV2 extends Structure {
        ...
        public WinDef.BOOL bPtzHorizotalScan;
        public WinDef.BOOL bPtzVerticalScan;
        public PU_STREAM_ABILITY_PARA[] stStreamAbility = (PU_STREAM_ABILITY_PARA[]) new PU_STREAM_ABILITY_PARA().toArray(PU_STREAM_NUM_V2);
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class SNAPSHOT_PARA extends Structure {
        ...
        public int enResolution;        //Resolution (The resolution cannot be set currently. The resolution of the primary stream is used.). c type:PU_RESOLUTION_TYPE
        public int enPictureFormat;    //Image format (Only the JPEG format is supported currently.). c type: PU_SNAPSHOT_FORMAT
    ...
    public static class PU_SNAPSHOT_RESOLUTION_PARA extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];    //szReserved[0] indicates whether the camera is a micro checkpoint camera. The options are 1 (yes) and 0 (no).
    ...
    public static class PU_SNMP_COMMUNITY_LIST extends Structure {
        ...
        public PU_SNMP_COMMUNITY_INFO[] szCommunityInfo = (PU_SNMP_COMMUNITY_INFO[]) new PU_SNMP_COMMUNITY_INFO().toArray(PU_SNMP_COMMUNITY_NUM);  //Community information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SNMP_COMMUNITY_LIST_EX extends Structure {
        public ULONG ulCommunityNum;                                               //Number of communities.
        public PU_SNMP_COMMUNITY_INFO_EX[] szCommunityInfo = (PU_SNMP_COMMUNITY_INFO_EX[]) new PU_SNMP_COMMUNITY_INFO_EX().toArray(PU_SNMP_COMMUNITY_NUM); //Community information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SNMPV3_USER_LIST extends Structure {
        ...
        public PU_SNMPV3_USER_INFO[] szUserInfo = (PU_SNMPV3_USER_INFO[]) new PU_SNMPV3_USER_INFO().toArray(PU_SNMPV3_USER_NUM);      //User information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_DOT1X_CONFIG_INFO extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                      //szReserved[0] indicates whether to enable EAP MD5. The options are 0 (no) and 1 (yes).
    ...
    public static class PU_CREATE_HTTPS_CERT extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("szCommonName", "szCountry", "szState", "szLocation", "szOrganization", "szUnit", "szEmail", "ulExpiredDays",
                    "szCreateCertPsw", "szReserve");
        }
    }
    ...
    public static class PU_LOCAL_RECORD extends Structure {
        ...
        public ULONG ulAction;                                        //Start or stop recording. The options are as follows: 0: stop; other digits: start.
    ...
    public static class PU_HARD_DISK_STATE extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];    //Reserved field. szReserved[0] indicates that disk ID. The options are as follows: 0: SD card; 1: eMMC card.
    ...
    public static class PU_SNAPSHOT_SPACE extends Structure {
        public ULONG ulPercentDecimal;          //Percentage of the snapshot storage space (decimal part containing two digits. The value 1 indicates 0.01%.).
    ...
    public static class PU_FTP_FILE_UPLOAD_PARA extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("bEnable", "enProtocol", "szServerIP", "ulServerPort", "szUserName", "szUserPwd", "enDirType", "enFirstDirType",
                    "enSecondDirType", "enFileNamingRule", "szFirstDir", "szSecondDir", "szReserved");
        }
    }
    ...
    public static class PU_LOCAL_RECORD_PLAN extends Structure {
        ...
        public PU_TIME_PLAN_LIST[] szRecordPlanList = (PU_TIME_PLAN_LIST[]) new PU_TIME_PLAN_LIST().toArray(PU_RECORD_PLAN_NUM_SD);//Recording plan list.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class CAM_FOCUSCTRL extends Structure {
        ...
        public ULONG ulFocusSpeed;                //Focus speed. For Sony devices, the value ranges from 0 to 7. For Hitachi devices, the value is 31.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_CAM_GEOG_POSITION extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];   //szReserved[0] indicates the mode of obtaining the longitude and latitude. In the value of szReserved[1], bit0 to bit4 respectively correspond to nHeight, fAzimuth, fPitch, dLongitude, and dLatitude.
    ...
    public static class PU_REAL_PLAY_INFO_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "hPlayWnd", "enStreamType", "enVideoType",
                    "enProtocolType", "enMediaCallbackType", "szLocalIp", "bKeepLive", "stStartTime", "stEndTime",
                    "enMediaCryptoType", "szMediaCrypto", "szReserved");
        }
    }
    ...
    public static class PU_REAL_PLAY_INFO_V20 extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "hPlayWnd", "enStreamType", "enVideoType",
                    "enProtocolType", "enMediaCallbackType", "szLocalIp", "bKeepLive", "stStartTime", "stEndTime",
                    "enIGTDataType", "szMulticastIP", "ulMulticastPort", "szReserved");
        }
    }
    ...
    public static class PU_VOICE_INFO extends Structure {
        ...
        public WinDef.BOOL bFeedAudioData;             //Indicates whether to feed data. (Voice intercom: When this parameter is set to TRUE, the callback function cannot be empty. When this parameter is set to FALSE, the callback function must be empty.)
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_MEDIA_PLAY_INFO extends Structure {
        public ULONG ulChannelId;                                              //Channel ID.
        public int enBusinessType;                              //Live video viewing, voice intercom, voice broadcast, and recording download. c type:PU_BUSINESS_TYPE
        public int enStreamType;                                  //Code stream type (primary stream, secondary stream 1, secondary stream 2). c type:PU_STREAM_TYPE
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                                //szReserved[0] indicates whether to enable the keep-alive function. The options are as follows: 0: yes; 1: no.
        //szReserved[1] indicates the packaging format of the intelligent analysis data. The value 0 indicates XML, and the value 1 indicates metadata.
        //szReserved[2] to szReserved[18] indicate the IV value of the AES256 CBC mode (16 bytes +1 end character).
        //szReserved[20] indicates the type of requested metadata. For details about the value, see the enumerated values of PU_METADATA_REQUEST_TYPE_E.
    ...
    public static class PU_MEDIA_PLAY_RSP extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulSessionId", "stPeerPortInfo", "szPeerIp", "enVideoEncodeType", "enAudioEncodeType", "stStartTime", "stEndTime",
                    "szReserved");
        }
    }
    ...
    public static class PU_ISP_PARTICULAR_PARA extends Structure {
        ...
        public PU_CAM_SLOW_SHUTTER_MODE stSlowShutterMode;                   //6: whether to enable slow shutter (not supported by ITS cameras and multi-algorithm models (full intelligence mode)).
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelID", "ulBitMap", "enAEMode", "lAEResponseTime", "stCamExpcompPara", "stCamWBManualPara", "stCamWDPara",
                    "stSlowShutterMode", "enCamFlickerMode", "stCamAEMeterMode", "stCamshutterValue", "stCamBackLightMode", "stCamIRCPara", "lAutoGainMaxValue",
                    "stCamGainControl", "stCamDenoisePara", "stCamStabilizerPara", "stCamIrisControl", "stISPDefogPara", "stImgDRCPara", "enMinFocusValue",
                    "stHlc", "enIrisType", "enShutterValueLimit", "stCamRoiMeterMode", "enRoiMeterType", "ulFaceExposureTime", "enPirisType", "szReserve");
        }
    ...
    /*White balance setting. The values of R and B can be fine-tuned in manual mode.*/
    public static class PU_CAM_WB_MANUAL_PARA extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("enWBMode", "ulROffset", "ulBOffset", "ulRStrong", "ulBStrong", "ulHighTemp", "ulLowTemp", "szReserve");
        }
    }

    /*WDR parameters.*/
    public static class PU_CAM_WD_PARA extends Structure {
        public int enSwitchMode;         //Indicates whether to enable the WDR (enable/disable/auto). c type:PU_COMMONMODE_SWITCH
        public int enWDMode;                 //WDR mode. If this parameter is set to WD_MODE_RATIOFIX, lExpRatio needs to be set.  c type:PU_VIDEO_WD_MODE
        public NativeLong lExpRatio;                              //Sony: x1–x64; Hitachi: 127
        public ULONG ulAutoModeMaxExpRatio;                 //Maximum exposure ratio in auto WDR mode. T1: 1–16. The default value is 8.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_AEMETERING_MODE extends Structure {
        public int enAEMeterSwitch;             //Indicates whether to enable the metering mode (enable/disable). c type:PU_COMMONMODE_SWITCH
        public int enAEMetering;            //Metering mode (center-weighted metering, average metering, and user-defined metering). c type:PU_VIDEO_AEMETERING_MODE
        public char[][] aucAreaWeight = new char[VW_ZONE_ROW][VW_ZONE_COLUMN];   //Exposure area weight (range: [0, 0xF]).
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_BACKLIGHT_MODE extends Structure {
        public int enBackLightMode;     //Indicates whether to enable backlight compensation (enable/disable). c type:PU_COMMONMODE_SWITCH
    ...
    public static class PU_IRC_PARA extends Structure {
        ...
        public ULONG ulSwitchLevel;                           //Switch to B/W triggered by external alarms. The options are as follows: 0: low level; 1: high level.  c type:PU_IRC_TRIGGER_MODE
    ...
    public static class PU_GAIN_CONTROL extends Structure {
        public int enGainSwitch;     //Indicates whether to enable gain control (enable/disable).  c type:PU_COMMONMODE_SWITCH
    ...
    public static class PU_DEFOG_PARA extends Structure {
        public int enDefog;            //Indicates whether to enable the defogging function. c type:PU_COMMONMODE_SWITCH
    ...
    public static class PU_ISP_HLC extends Structure {
        public int enHlc;    //Indicates whether to enable the HLC (enable/disable). c type:PU_COMMONMODE_SWITCH
    ...
    public interface PU_SCENE_PARAM_TYPE {
        ...
        public static final int PU_SCENE_PARAM_SNAPSHOT = 1; //Scene parameter of the ITS camera or multi-algorithm concurrency camera in full intelligence or micro checkpoint mode.
        public static final int PU_SCENE_PARAM_HUMAN = 2;    //Scene parameter of the multi-algorithm concurrency camera in face capture or behavior analysis mode.
        public static final int PU_SCENE_PARAM_VEHICLE = 3;  //Scene parameter of the multi-algorithm concurrency camera in micro checkpoint mode.
    ...
    public static class PU_TYPICAL_SCENE_LIST extends Structure {
        ...
        public PU_TYPICAL_SCENE_INFO[] stTypicalSceneInfo = (PU_TYPICAL_SCENE_INFO[]) new PU_TYPICAL_SCENE_INFO().toArray(PU_TYPICAL_SCENE_NUM_MAX);  //Information list.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_TYPICAL_SCENE_LIST_EX_OUT extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];               //Reserved field. [0] indicates the parameter type. For details, see PU_SCENE_PARAM_TYPE_E.
    ...
    public static class PU_ISP_SCENE_PARA extends Structure {
        public ULONG ulIndex;                                  //Unique ID. The digits 1-4 indicate basic settings and cannot be deleted. Set this parameter to 0 when adding an ISP profile. To modify or delete an ISP profile, enter the specified index.
        public byte[] szName = new byte[PU_TYPICAL_SCENE_NAME_LEN];         //Typical scene profile name.
    ...
    public static class PU_IRLIGHT_LIST extends Structure {
        ...
        public PU_IRLIGHT_PARA[] stIRLightMPara = (PU_IRLIGHT_PARA[]) new PU_IRLIGHT_PARA().toArray(PU_IRLIGHT_NUM_MAX);           //Infrared illuminator data. This parameter is mandatory in manual mode.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                                //szReserved[0] indicates whether to enable the intelligent infrared illuminator. The options are 0 (yes) and 1 (no).
        //szReserved[1] indicates the infrared coefficient that ranges from 1 to 100.
        //szReserved[2] indicates whether to enable safety restriction. The options are 0 (no) and 1 (yes).
    ...
    public static class PU_MONTHS_PLAN extends Structure {
        public ULONG ulMonth;                                        //Month. If the value is 0, all the 12 months need to be set. If the value is from 1 to 12, data of the corresponding month needs to be saved.
        public WinDef.BOOL bEnable;                                        //Indicates whether to enable the OSD.
        public PU_TIME_QUANTUM_LIST[] stTimeQaumtumMonths = (PU_TIME_QUANTUM_LIST[]) new PU_TIME_QUANTUM_LIST().toArray(PU_MONTH_NUM);
    ...
    public static class PU_TIME_QUANTUM_LIST extends Structure {
        public ULONG ulTimeQuantumNum;                               //Number of the first several valid time segments. Generally, the value is specified by MAX_TIMEQAUMTUM_NUM.
        public PU_TIME_QUANTUM_INFO[] stTimeQuantumInfo = (PU_TIME_QUANTUM_INFO[]) new PU_TIME_QUANTUM_INFO().toArray(PU_PLAN_NUM_MAX);
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ISP_PROFILES_LINK_INFO extends Structure {
        ...
        public PU_ISP_PROFILES_LINK_MODE[] szLinkMode = (PU_ISP_PROFILES_LINK_MODE[]) new PU_ISP_PROFILES_LINK_MODE().toArray(PU_IRCUT_MODE_MAX_NUM);  //Linkage list.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];     //Reserved field.
    ...
    public static class PU_AUTO_APERTURE_PARA extends Structure {
        public ULONG ulChannelId;                //Channel ID.
        public WinDef.BOOL bEnable;                     //Indicates whether to enable auto iris. The options are as follows: 0: yes; 1: no.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];  //Reserved field.
    ...
    public static class PU_PTZ_FOCUSAREA extends Structure {
        public ULONG ulChannelID;                                      //Channel ID.
        public ULONG[][] ulFocusArea = new ULONG[PU_FOCUSAREA_ROW][PU_FOCUSAREA_COL];  //Automatic focus environment data.
    ...
    public static class PU_SNMP_TRAP_INFO extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                      //szReserved[0]: applied network adapter. The value 0 indicates network adapter 1. The value 1 indicates network adapter 2. The rest can be deducted by analogy.
    ...
    public static class PU_SNMP_TRAP_LIST extends Structure {
        ...
        public PU_SNMP_TRAP_INFO[] szTrapInfo = (PU_SNMP_TRAP_INFO[]) new PU_SNMP_TRAP_INFO().toArray(PU_SNMP_TRAP_NUM);     //Information about the trap receiver.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_SNMP_AUTH_INFO extends Union {
        public byte[] szCommunityName = new byte[PU_SNMP_COMMUNITY_NAME_LEN];     //Community name, which is used to send SNMP v1/v2c trap messages.
    ...
    public static class PU_VLPR_PARA_V3_S extends Structure {
        ...
        public PU_IMRS_LINE_S[] stLane = new PU_IMRS_LINE_S[MAX_AREA_VERTEX];        //Number of lane lines = Number of lanes + 1
        public int enVehicleDir;           //Vehicle direction (vehicle front direction by default).
        public int enCatchMode;            //Snapshot type. The options are as follows: 0: motor vehicle; 1: motor vehicle, non-motor vehicle, and pedestrian.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChnID", "bEnable", "iLaneNum", "stLane", "enVehicleDir",
                    "enCatchMode", "stVLPParam", "bVColorDetection", "bVTypeDetection", "bSendPanoramaPic", "bSendPlatePic", "enAlgMode",
                    "bExposureEnable", "ulROIMeterLevel", "bVlprEnhancement", "stLaneAttr", "stAreaList", "stDetectLine", "bEnableVehicleMfrType", "bEnableFacePic", "stCampusModePara", "szReserved");
        }
    }
    ...
    public static class PU_CAMPUS_MODE_PARA_S extends Structure {
        ...
        public WinDef.BOOL bEnable;                     //Indicates whether to enable license plate detection at the campus entrance and exit.
        public int enTrigType; //Trigger type. The options are as follows: 0: loop; 1: tripwire; 2: hybrid.c type:PU_CAMPUS_TRIG_TYPE_E
    ...
    public static class PU_VLP_PARA_S extends Structure {
        ...
        public int iPlateSize;                             //License plate type. The options are as follows: 0: small license plate; 1: large license plate; 2: micro license plate. The resolution of a small license plate ranges from 40 to 200 pixels and that of a large license plate ranges from 200 to 400 pixels.
    ...
    public static class LPR_CAPTURE_RES_S extends Structure {
        ...
        public byte[] szReserved = new byte[512];        //Reserved field. szReserved[0] to szReserved[32] are reserved for RS-485 external device serial numbers.
    ...
    public static class PU_VHD_PARA_EX extends Structure {
        ...
        public int iLaneNum;                               //Lane quantity.
        public PU_IMRS_LINE_S[] stLane = new PU_IMRS_LINE_S[MAX_AREA_VERTEX];                //Number of lane lines = Number of lanes + 1
        public byte[] szPlateLocalZH = new byte[MAX_PLATE_LOCAL_ZH_LEN]; //Preferred city type. A maximum of six city types can be selected. If the number of types exceeds six, six are preferred. For example, Shanghai, Jiangsu, and Zhejiang.
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "bEnable", "bSendSnapPicture", "bSendPanorama", "bLaneLineEnable", "enAlgMode", "iWidth", "iHeight",
                    "iLaneNum", "stLane", "szPlateLocalZH", "bExposureEnable", "ulROIMeterLevel", "stLaneAttr", "stAreaList", "szReserved");
        }
    }
    ...
    public static class PU_VLPR_PARA_V2_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChnID", "bEnable", "iLaneNum", "stLane", "enVehicleDir",
                    "enCatchMode", "stVLPParam", "bVColorDetection", "bVTypeDetection", "bSendPanoramaPic", "bSendPlatePic", "enAlgMode", "szReserved");
        }
    }
    ...
    public static class PU_VLPR_PARA_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChnID", "bEnable", "iLaneNum", "stLane", "enVehicleDir",
                    "enCatchMode", "stVLPParam", "bVColorDetection", "bVTypeDetection", "bSendPanoramaPic", "bSendPlatePic");
        }
    }
    ...
    public static class PU_ATTRI_DL_PARAMETER_S extends Structure {
        ...
        //    BOOL     enEnableAttri;    // Indicates whether to enable facial attribute recognition.
//BOOL enEnableBodyAttri; // Indicates whether to enable personal attribute recognition.
    ...
    public static class PU_SUPPLEMENT_LAMP_ATTR_S extends Structure {
        public ULONG ulChannelId;                    //Channel ID.
        public PU_STROBE_LAMP_ATTR_S[] stStrobeLampAttr = new PU_STROBE_LAMP_ATTR_S[PU_MAX_INNER_LAMP_NUM]; //Internal strobe light attribute.
        public PU_EXT_LAMP_ATTR_S[] stExtLampAttr = new PU_EXT_LAMP_ATTR_S[PU_MAX_EXT_LAMP_NUM]; //External illuminator attribute.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_DENOISE_PARA_S extends Structure {
        ...
        public NativeLong lNRLevel;                              //Noise reduction level. For Sony devices, the value ranges from 1 to 5; for Hitachi devices, the value ranges from 1 to 3.
    ...
    public static class PU_IRC_PARA_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("enIRCMode", "ulDayToNightThreshold", "ulNightToDayThreshold", "ulSwitchLevel", "enIRCutSwitchMode", "enPolarzerMode", "szReserve");
        }
    }
    ...
    //ROI metering type (license plate metering of micro cameras/face metering of face detection cameras).
    ...
    public static class PU_SNAPSHOT_PARTICULAR_PARA_S extends Structure {
        ...
        public PU_CAM_AE_RESPONSE_TIME_S stCamAEResponseTime;              //2: AE response time (This parameter is invalid for V200R002 devices.)
    ...
    public interface PU_ISP_PARTICULAR_PARA_TYPE_E {
        int PU_ISP_HUMAN = 0;            //ISP parameter of the multi-algorithm concurrency camera in face capture or behavior analysis mode.
        int PU_ISP_HUMAN_DEFAULT = 1;    //Default ISP parameter of the multi-algorithm concurrency camera in face capture or behavior analysis mode. The parameter can be obtained only.
        int PU_ISP_VEHICLE = 2;          //ISP parameter of the multi-algorithm concurrency camera in micro checkpoint mode.
        int PU_ISP_VEHICLE_DEFAULT = 3;   //Default ISP parameter of the multi-algorithm concurrency camera in micro checkpoint mode. The parameter can be obtained only.
    ...
    public static class PU_HUMANCOUNT_TABLE_S extends Structure {
        ...
        public PU_HUMANCOUT_RECORD[] astTable = new PU_HUMANCOUT_RECORD[PU_HUMANCOUNT_TABLE_LEN_MAX];  //Table displaying the head count statistics in each time segment.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public interface PU_ALARM_LINK_PTZ_PRIORITY_E {
        int PU_GUARD_FIRST = 0; //Park action first. (When the park waiting time elapses, the park action is triggered no matter whether any alarm is generated.)
        int PU_ALARM_FIRST = 1;     //Alarm linkage first. (During the alarming period, the park action does not take effect.)
        int PU_LINK_MAX = 2;
    }
    ...
    /*exp：2 ----1 BNC1+D1 1 VGA1||HDMI1 + 1080P
    5 ----1 BNC1+D1  4 VGA1||HDMI1 + D1
    3 ----1 BNC1+D1 1 VGA1+720P 1 HDMI1+720P ==== From different sources
    2 ----1 VGA1+720P 1 HDMI1+720P ====  From different sources*/
    public static class PU_DEC_CHANNEL_ABILITY extends Structure {
        ...
        //    BOOL bAudioFlag;                                              // Audio switch. A decoder supports only one audio output channel. If the audio device has been enabled in a decoder channel, it will be disabled in other channels by default.
    ...
    public static class PU_DEC_CHANNEL_ABILITY_LIST extends Structure {
        ...
        public PU_DEC_CHANNEL_ABILITY[] stChnAttri = new PU_DEC_CHANNEL_ABILITY[PU_CHANNEL_NUM_MAX];           //Channel attribute.
    ...
    public class PU_PTZ_PRESET_LIST_PARA extends Structure {
        ...
        public PU_PTZ_PRESET_INFO[] stPtzPresetInfo = new PU_PTZ_PRESET_INFO[PU_PTZ_PRESET_NUM];        //Preset position information.
    ...
    public class PU_PTZ_CRUISE_TRACK_PARA extends Structure {
        ...
        public PU_CRUISE_POINT[] stCruisePoint = new PU_CRUISE_POINT[PU_PTZ_CRUISE_POINT_MAX];       //List of preset positions in a tour.
    ...
    public class PU_PTZ_CURRENT_LOCATION extends Structure {
        ...
        public int ulLenMultiple;                    //Integral part of the lens zoom ratio (1–30. If the digital zoom is not 0, the lens zoom ratio is the maximum value 30 by default.).
        public int ulDotLenMultiple;                 //Decimal part of the lens zoom ratio (0–99; accurate only to one decimal place).
        public int ulZoomRatio;                      //Integral part of the digital zoom (0–12. The parameter is set when the lens zoom ratio reaches the maximum value. The value 0 indicates that this parameter is not set. The total zoom ratio is the multiplication of zoom ratios.)
        public int ulDotZoomRatio;                   //Decimal part of the digital zoom (0–99; accurate only to one decimal place).
        public int lPTZDotHorDegree;                        //Decimal part of the horizontal angle (0–99; accurate only to one decimal place).
        public NativeLong lPTZDotVerDegree;                 //Decimal part of the vertical angle (–99 to +99; accurate only to one decimal place).
        public byte[] szReserved = new byte[PU_RESERVE_LEN];

        protected List<String> getFieldOrder() {
            return Arrays.asList("lPTZHorDegree", "lPTZVerDegree", "ulLenMultiple", "ulDotLenMultiple", "ulZoomRatio", "ulDotZoomRatio",
                    "lPTZDotHorDegree", "lPTZDotVerDegree", "szReserved");
        }
    }
    ...
    //PTZ preset position (including the function of enabling or disabling focus memory).
    public static class PU_PTZ_PRESET_PARA_EX extends Structure {
        ...
        public int enPresetCmd;        //Preset position command word.
        public WinDef.BOOL bEnableFocusInfo;                    //Indicates whether to enable focus memory. The options are as follows: 0: disable; 1: enable.
    ...
    //Preset position information (including the function of enabling or disabling focus memory).
...
//        }
    ...
    //PTZ preset position list (including the function of enabling or disabling focus memory).
    public static class PU_PTZ_PRESET_LIST_PARA_EX extends Structure {
        ...
        public PU_PTZ_PRESET_INFO_EX[] stPtzPresetInfo = new PU_PTZ_PRESET_INFO_EX[PU_PTZ_PRESET_NUM];     //Preset position information.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];                                    //Reserved field.
    ...
    public static class PU_SUPPLEMENT_LIGHT_LAMP_INFO_S extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                    //szReserver[0] indicates the illuminator brightness. The value ranges from 1 to 100. The default value is 50.
    ...
    public static class PU_SUPPLEMENT_LIGHT_INFO_S extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];     //szReserved[0] indicates the illuminator type. For details, see PU_SUPPLEMENTLAMP_TYPE_E.

        //szReserved[1] indicates the illuminator control mode. For details, see PU_LAMP_CTRL_MODE_E.
        //szReserved[2] indicates the illuminator control type. For details, see PU_CAPLAMPCTRL_TYPE_E.
        //szReserved[3] indicates the intelligent infrared level. The value ranges from 0 to 100. The default value is 50.
    ...
    /*************BEGIN: Parameters for uploading images captured by micro checkpoint cameras through FTP or SFTP ***************/
    /************* Separator type ***************/
    ...
    public static class PU_VLPR_FTP_DIR_PARA_S extends Structure {
        ...
        public PU_VLPR_FTP_DIR_NAMING_ELEM_S[] astDirNamingElem = (PU_VLPR_FTP_DIR_NAMING_ELEM_S[]) new PU_VLPR_FTP_DIR_NAMING_ELEM_S().toArray(PU_MAX_DIR_NAMING_ELEM);
        public byte[] szReserved = new byte[PU_RESERVE_LEN];          //Reserved field.
    ...
    public static class PU_VLPR_FTP_UPLOAD_PARA_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("bSnapPicEnable", "bSendPlatePic", "enProtocol", "szServerIP", "ulServerPort", "szUserName", "stDirNameingPara", "stPicNamingPara", "eFtpType", "bSendFacePic", "szReserved", "szUserPwd");
        }
    }
    ...
    /*************End: Parameters for uploading images captured by micro checkpoint cameras through FTP or SFTP ***************/
    ...
    public static class PU_ISP_ALG_INFO_S extends Structure {
        ...
        public PU_ALG_INFO_S[] szAlgInfos = new PU_ALG_INFO_S[PU_ISP_TYPE_MAX_NUM];  //Algorithm version information. For further expansion, 64 algorithms are reserved. Currently, only the scene adaptation algorithm is supported.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITS_MANUAL_SNAPSHOT_PARA_S extends Structure {
        public ULONG ulSnapNum;    //Maximum number of snapshots (MAX_BURST_SHOOTING_NUM). Currently, only one snapshot is supported.
        public ULONG[] aulSnapInterval = new ULONG[MAX_BURST_SHOOTING_NUM - 1];  //Snapshot interval, in milliseconds. The value ranges from MIN_ITS_SNAPSHOT_INTERVAL to MAX_ITS_SNAPSHOT_INTERVAL.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_DEV_ALARM_INFO_REPORT extends Structure {
        ...
        public BOOL IsIntact;                       //Indicates whether a device is intact. The options are as follows: 1: yes; 0: no.
    ...
    public static class PU_IPFILTER_RULES_INFOV2_S extends Structure {
        ...
        public ULONG ulIpFilterRulesNum;                                       //IP address filtering rule item.
        public PU_IPFILTER_RULESV2_S[] stIpFilterRulesList = new PU_IPFILTER_RULESV2_S[PU_IP_FILTER_NUM_MAXV2];  //IP address filtering rule list.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_RESOLUTION_INFO extends Structure {
        public PU_RESOLUTION_BASIC_PARA[] astResolutionPara = new PU_RESOLUTION_BASIC_PARA[PU_STREAM_MODE_E.PU_VIEDO_STREAM_TRIPLE];  //Basic video resolution parameter.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_MANAGE_3RD_APP_INFO extends Structure {
        ...
        public PU_3RD_APP_BASIC_INFO[] ast3RdAppInfo = (PU_3RD_APP_BASIC_INFO[]) new PU_3RD_APP_BASIC_INFO().toArray(PU_3RD_APP_MAX_NUM);     //Third-party algorithm app information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public interface PU_UPGRADE_ITGT_TYPE_E {
        ...
        int PU_UPGRADE_ITGT_TYPE_OBJ_CLASSIFICATION = 8;               //Object classification and license plate detection algorithm package.
        int PU_UPGRADE_ITGT_TYPE_NON_CHINA_VEHICLE_RECOGTION = 16;     //Non-Chinese license plate detection algorithm package.
        int PU_UPGRADE_ITGT_TYPE_SCENE_ADAPTATION = 32;                //Scene adaptation algorithm package.
        int PU_UPGRADE_ITGT_TYPE_QUEUE_LENTH_CROWD_COUNT = 33;              //Queue length/Crowd density detection algorithm package.
        int PU_UPGRADE_ITGT_3RD_TYPE_APP = 64;                         //Third-party app package.
        int PU_UPGRADE_LET_4G_MODEL = 65;                                   //4G software package.
        int PU_UPGRADE_DCHIP_TYPE_APP = 66;                                 //DaVinci Mini chip (Ascend 310) upgrade package. The device needs to be restarted.
        int PU_UPGRADE_DCHIP_TYPE_ALG = 67;                                 //DaVinci Mini chip (Ascend 310) algorithm package, containing multiple algorithms. All the algorithms must be upgraded to the same version.
    ...
    public static class PU_UPGRADE_ITGT_FILE_INFO extends Structure {
        public PU_UPGRADE_ITGT_MODEL_PARA[] astItgtModelPara = new PU_UPGRADE_ITGT_MODEL_PARA[PU_UPGRADE_FILE_NUM_MAX]; //Intelligent algorithm upgrade package information.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public interface DIAL_AUTH_TYPE_E {
        ...
        int DIAL_AUTH_CHAP_PAP = 0x03;    /*Try CHAP authentication and then PAP authentication (if CHAP authentication fails).*/
    }

    /******** DIAL   ********/
    public static class PU_DIALING_PARA_S extends Structure {
        // C type: DIAL_AUTH_TYPE_E
        public int enAuthType;                    /*Authentication type (The user name and password can be left empty if no authentication is required.).*/
    ...
    public interface PU_ENABLE_TYPE_E {
        /*Enumeration parameters must be arranged in descending order. Otherwise, a value is automatically assigned to each enumeration parameter.*/
    ...
    public static class PU_DIALING_PLAN_DAY_S extends Structure {
        public PU_TIME_RANGE_MIN_S[] szTimeRange = (PU_TIME_RANGE_MIN_S[]) new PU_TIME_RANGE_MIN_S().toArray(DIAL_PLAN_AREA_MAX);
    ...
    public static class PU_AUTO_DIALING_PLAN_S extends Structure {
        public PU_DIALING_PLAN_DAY_S[] szDalingPlan = (PU_DIALING_PLAN_DAY_S[]) new PU_DIALING_PLAN_DAY_S().toArray(DAYS_PER_WEEK);
    ...
    public static class PU_SMS_WHITE_LISTS_S extends Structure {
        public PU_SMS_WHITE_LISTS_S[] szSmsWhiteList = (PU_SMS_WHITE_LISTS_S[]) new PU_SMS_WHITE_LISTS_S().toArray(DIAL_SMS_WHITE_LIST_MAX);
    ...
    public interface PU_ITS_RADAR_MSG_SENDTYPE_E {
        ...
        int ITS_RADAR_MSG_SEND_CONTINOUS = 1;   //Continuous (messages are reported regardless of whether a vehicle passes).
    ...
    public static class PU_ITGE_MODE_E {
        ...
        int VHD_FACE_MODE = 6;  //Multi-purpose camera (object classification mode + face detection)/C30 full intelligence.
    ...
    public static class PU_RADA_PARA_CHUANSU_S extends Structure {
        ...
        public ULONG uiFixedAngle;                            //Angle to be corrected. If the speed estimated by radar is inconsistent with the actual speed, correct the angle.
        public ULONG uiSensitivity;                           //Radar sensitivity.
        public ULONG uiTrigMinInterval;                       //Minimum triggering distance.
        public ULONG uiTrigMinSpeed;                          //Minimum triggering speed. If the vehicle speed is below the lower limit, radar detection will not be triggered.
    ...
    public static class PU_ITS_RADA_CTRL_CSRIM_S extends Structure {
        ...
        public ULONG uiLaneId;                           //Lane ID. The value 1 indicates that lane 1 is enabled, and the rest may be deduced by analogy.
        public ULONG uiLaneIdBase;                       //Start lane ID.
        public ULONG uiLaneNum;                          //Number of lanes.
        public ULONG[] uiLaneWidth = new ULONG[4];       //Lane width. The value is in centimeters in the web configurations and is converted into meters in actual scenarios.
        public ULONG uiTrigMinInterval;                  //Minimum triggering distance. The value is in centimeters in the web configurations and is converted into meters in actual scenarios.
        public ULONG uiInstallHeight;                    //Installation height. The value is in centimeters in the web configurations and is converted into meters in actual scenarios.
        public NativeLong iInstallHOffset;                    //Offset between the radar irradiation point and the lane center. The value is in centimeters in the web configurations and is converted into meters in actual scenarios.
        //If the radar irradiation point is on the left of the lane center, the offset is a negative integer. If the radar irradiation point is on the right of the lane center, the offset is a positive integer.
        public NativeLong iDeflectionAngle;                   //Angle between the radar irradiation direction and a lane.
        //If the radar irradiation direction deviates leftward, the value is a negative integer. If the radar irradiation direction deviates rightward, the value is a positive integer.
        public ULONG uiSensitivity;                      //Radar sensitivity.
        public ULONG uiSensitiveBase;                    //Radar sensitivity base.
        public ULONG uiTrigMinSpeed;                     //Minimum speed (km/h). If the vehicle movement speed is lower than this value, radar detection is not triggered.
        public ULONG uiTrigMaxSpeed;                     //Maximum speed (km/h). If the vehicle movement speed is higher than this value, the maximum speed is reported.
        // C type PU_ITS_DETECT_DIR_E
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("enSerialPortId", "uiRoadEnable", "uiLaneId", "uiLaneIdBase", "uiLaneNum", "uiLaneWidth", "uiTrigMinInterval",
                    "uiInstallHeight", "iInstallHOffset", "iDeflectionAngle", "uiSensitivity", "uiSensitiveBase", "uiTrigMinSpeed", "uiTrigMaxSpeed",
                    "eDetectDir", "szReserve");
        }
    }
    ...
    public static class PU_LIGHT_DETECTOR_INFO_S extends Structure {
        ...
        public ULONG uiLightLaneId;                          //ID of the lane covered by the external device. The value 1 indicates that detection for lane 1 is enabled, and the rest may be deduced by analogy.
        // C type PU_ITS_SERIAL_PORT_E
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("enDeviceProtelType", "uiLightRoadEnable", "uiLightLaneId", "enLightSerialPortId", "stLightDevSerialCfg",
                    "stCfgLightDetector", "szReserve");
        }
    }
    ...
    public static class PU_VEHICLE_DETECTOR_INFO_S extends Structure {
        ...
        public ULONG uiDetectLaneId;                         //ID of the lane covered by the external device. The value 1 indicates that detection for lane 1 is enabled, and the rest may be deduced by analogy.
        // C Type : PU_ITS_SERIAL_PORT_E
    ...
    public static class PU_IO_DETECTOR_INFO_S extends Structure {
        ...
        public ULONG uiIOLaneId;                             //ID of the lane covered by the external device. The value 1 indicates that detection for lane 1 is enabled, and the rest may be deduced by analogy.
    ...
    public static class PU_ITS_DEV_SPEC_S extends Structure {
        ...
        public int enExtraType;                            //External device type. The options are as follows: 0: no external device; 1: radar; 2: vehicle detector; 3: I/O detector. The devices are mutually exclusive. (The protocol type must match the device type specified by this parameter.)
        public PU_ITS_DEV_INFO_S[] stDevSpecInfo = (PU_ITS_DEV_INFO_S[]) new PU_ITS_DEV_INFO_S().toArray(PU_ITS_MAX_ROAD_NUM);        //Parameter configuration based on lanes.
...
//Local SIM card number.
    ...
    public static class PU_ITGT_ALTHM_BASIC_INFO extends Structure {
        ...
        public BOOL bEnableAlthm;                                //Indicates whether to enable the algorithm. The options are as follows: 0: no; 1: yes.
    ...
    public static class PU_ITGT_ALTHM_INFO extends Structure {
        ...
        public PU_ITGT_ALTHM_BASIC_INFO[] astItgtAlthmBasInfo = new PU_ITGT_ALTHM_BASIC_INFO[PU_ITGT_TYPE_MAX_NUM];   //Detailed algorithm information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITGT_ALTHM_INFO_EX extends Structure {
        public int ulChannelID;                                      //Channel ID.
        public int uiValidCount;                                                      //Number of valid algorithms.
        public PU_ITGT_ALTHM_BASIC_INFO[] astItgtAlthmBasInfo = new PU_ITGT_ALTHM_BASIC_INFO[PU_ITGT_TYPE_MAX_EX_NUM];   //Detailed algorithm information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITGT_LIC_SERVICE_INFO extends Structure {
        ...
        public PU_ITGT_LIC_CONTROL_INFO[] astLicControlInfo = new PU_ITGT_LIC_CONTROL_INFO[PU_ITGT_TYPE_MAX_NUM];   //Intelligent algorithm license control information.
    ...
    public static class PU_ITGT_LIC_SERVICE_INFO_EX extends Structure {
        ...
        public byte[] szLicServiceAge = new byte[PU_LIC_SERVICE_AGE_MAX_LEN];                      //Service lifespan.
        public PU_ITGT_LIC_CONTROL_INFO[] astLicControlInfo = new PU_ITGT_LIC_CONTROL_INFO[PU_ITGT_TYPE_MAX_EX_NUM];   //Intelligent algorithm license control information.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public interface PU_FEATURE_STATUS_TYPE_E {
        ...
        int FEATURE_STATUS_FAILED = 5;              //Extraction failure; used to query face images whose features fail to be extracted.
    ...
    public static class PU_FACE_LIB_GET_S extends Structure {
        ...
        public byte[] szFindResultPath = new byte[PU_SAVE_FILE_PATH_MAX]; //Query result path (a local directory for the client; a JSON file path for the device).
    ...
    public static class PU_FACE_INFO_FIND_S extends Structure {
        ...
        public byte[] szFindResultPath = new byte[PU_SAVE_FILE_PATH_MAX + 1];// Query result path (a local directory for the client; a JSON file path for the device).
    ...
    public static class PU_FACE_LIB_IMPORT_S extends Structure {
        ...
        public byte[] szImportResult = new byte[PU_IMPORT_FILE_LEN_MAX]; //Path for saving the exported file in CSV format. This field is not used in IVS_PU_ImportFaceLibEx.
    ...
    public static class PU_FACE_LIB_STATUS_S extends Structure {
        ...
        public WinDef.BOOL status;                                            //Import and feature extraction status. The options are as follows: 1: finished; 0: not finished.

        public WinDef.ULONG totalPicNum;                                  // Total number of imported files and extracted features.

        public WinDef.ULONG finishPicNum;                                 //Number of successfully imported files and files from which features are successfully extracted.

        public byte[] szResultCsvPath = new byte[PU_IMPORT_FILE_LEN_MAX]; // Path for saving the import and feature extraction results in CSV format.

        public byte[] szReserve = new byte[PU_RESERVE_LEN];

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "stFacelib", "taskID", "status", "totalPicNum",
                    "finishPicNum", "szResultCsvPath", "szReserve");
        }
    }
    ...
    public static class PU_FACE_RECORD_S extends Structure {
        ...
        public byte[] szPicPath = new byte[PU_SAVE_FILE_PATH_MAX]; //Path for uploading images on the client and full path for storing images on the device, which is specified on the SDK server.
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulFaceId", "szName", "enGender", "szBirthday", "szProvince", "szCity",
                    "enCardType", "szCardID", "szExtensionField", "szPicPath", "szReserve");
        }
    }
    ...
    public static class PU_FACE_FEATURE_GET_S extends Structure {
        ...
        public byte[] szExportCsvPath = new byte[PU_SAVE_FILE_PATH_MAX];     //Path of the CSV file for storing the exported results.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITS_ILLEGAI_DIC_PARA_UNIT_S extends Structure {
        public byte[] szIllTypeString = new byte[PU_ITS_ILLEGAL_TYPE_LEN_MAX];       //Violation type, which cannot be modified. The maximum length is as follows: PU_ITS_ILLEGAL_TYPE_LEN_MAX – 4.
        public byte[] szIllCodeString = new byte[PU_ITS_ILLEGAL_NUM_LEN_MAX];        //Violation code. The maximum length is as follows: PU_ITS_ILLEGAL_NUM_LEN_MAX – 1.
        public byte[] szIllNameString = new byte[PU_ITS_ILLEGAL_NAME_LEN_MAX];       //Superimposed violation name. The maximum length is as follows: PU_ITS_ILLEGAL_NAME_LEN_MAX – 4.
    ...
    public static class PU_ITS_ILLEGAI_DIC_PARAM_S extends Structure {
        ...
        public PU_ITS_ILLEGAI_DIC_PARA_UNIT_S[] astIllegals = (PU_ITS_ILLEGAI_DIC_PARA_UNIT_S[]) new PU_ITS_ILLEGAI_DIC_PARA_UNIT_S().toArray(PU_ITS_ILLEGAL_TYPE_NUM_MAX);   //Violation item.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_RL_FRAME_PARA extends Structure {
        public PU_RL_LIGHTINFOS_PARA[] stLightInfo = (PU_RL_LIGHTINFOS_PARA[]) new PU_RL_LIGHTINFOS_PARA().toArray(PU_RL_NUM_MAX);   //Red light status.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public interface PU_ITS_REGULA_TYPE_E {
        ...
        int ITS_REGULA_WRONG_DIRECTION = 5; /* Not following lane markings, including left-turn/straight-through/right-turn (1208).*/
        ...
        int ITS_REGULA_PORT_VEHICLE_DRIVER_CALL = 18;  /*Hands-free device infraction (driver), triggered by checkpoint devices.*/
        int ITS_REGULA_PORT_VEHICLE_COPILOT_NO_BELT = 19;  /*Seat belt infraction (front passenger), triggered by checkpoint devices.*/
        int ITS_REGULA_PORT_VEHICLE_NO_YEAR_LOG = 20;  /*No annual inspection sticker, triggered by checkpoint devices.*/
        ...
        int ITS_REGULA_RECOGNIZE_ONLY = 30;          /* ePolice six-in-one function. This enumeration parameter is used when traffic flow only needs to be recognized and metadata does not need to be uploaded.*/
    ...
    //Additional parameters for snapshots of motor vehicles driving on non-motor vehicle lanes.
    ...
    public class tagITSRegulationCfgAttch extends Union {
        /**
         * Running-red-light snapshot parameter (ITS_REGULA_RUNNINGRED), which is a reserved field.<br>
         */
        ...
        /**
         * Motor vehicles driving on non-motor vehicle lanes (ITS_REGULA_MOTOR_IN_BICYCLE_LANE).<br>
         */
        ...
        /**
         * @param stRunningRed Running-red-light snapshot parameter (ITS_REGULA_RUNNINGRED), which is a reserved field.
        ...
        /**
         * @param stPressLine Marked lanes violation (ITS_REGULA_OVER_LANE_LINE).
        ...
        /**
         * @param stInvadeDriverWay_or_stInvadeBusLane_or_stIllegalParkTime_or_stImpolitePedestriansTime Motor vehicles driving on non-motor vehicle lanes (ITS_REGULA_MOTOR_IN_BICYCLE_LANE).
         *                                                                                               C type : PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S, or Bus lane violation (ITS_REGULA_OCCUPANCY_BUSLANE).
         *                                                                                               C type : PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S, or Parking in yellow zones (ITS_REGULA_ILLEGAL_PARKING).
         *                                                                                               C type : PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S, or Pedestrian waiting time.
    ...
    public static class tagItsEPoliceSnapType extends Structure {
        ...
        /* ePolice:1: checkpoint; 3: speeding; 4: low-speed; 6: wrong-way driving; 7: end-number policy violation; 8: marked lanes violation; 9: unsafe lane change; 10: motor vehicles on non-motor vehicle lanes
         *         21: parking in yellow zones; 22: failure to give right-of-way to pedestrians; 23: bus lane violation; 24: driving large vehicles on prohibited lanes;
         *
         * Checkpoint: 1: checkpoint; 3: speeding; 4: low-speed; 6: wrong-way driving; 7: end-number policy violation; 8: marked lanes violation; 9: unsafe lane change; 10: motor vehicles on non-motor vehicle lanes; 18: hands-free device infraction;
         *      * 19: Seat belt infraction; 21: parking in yellow zones; 22: failure to give right-of-way pedestrians; 23: bus lane violation; 24: driving large vehicles on prohibited lanes;
         *
         */
        public int iRegulationNum;  //Number of violation snapshots (ePolice: 14; checkpoint: 15).
        public tagRegulationSnapConfigUnit[] astRegulationSnapCfgU = (tagRegulationSnapConfigUnit[]) new tagRegulationSnapConfigUnit().toArray(ITS_REGULATION_TYPE_NUM_MAX); //Violation snapshot type.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public interface LANE_DIRECTION_E {
        ...
        int LANE_DIRECTION_UNDEF = 2; /*The direction is not defined, so wrong-way driving cannot be detected. Only the vehicle speed is provided. */
    }
    ...
    public static class tagRoadPropertyUnit extends Structure {
        /**
         * Lane direction in video (leaving or approaching).
         * C type : PU_ITS_CAR_DRV_DIR_E
         */
        public int enLaneDirection;
        /**
         * Vehicle direction (turn-left, turn-right, or straight-through).
    ...
    public static class tagItsEPoliceDtLineParam extends Structure {
        ...
        public ROAD_PROPERTY_UNIT_S[] stLane = (ROAD_PROPERTY_UNIT_S[]) new ROAD_PROPERTY_UNIT_S().toArray(MAX_LANE_NUM);           //Number of lane lines = Number of lanes + 1
        ...
        public PU_IMRS_LINE[] stTripLine = (PU_IMRS_LINE[]) new PU_IMRS_LINE().toArray(MAX_LANE_NUM);       //Detection line (virtual tripwire), across which snapshots are taken in checkpoint mode.
    ...
    public static class PU_ITS_DT_LINE_PARAM extends Structure {
        ...
        //[Difference from the service structure] The union is deleted and the parameter structure is directly defined.
    ...
    public static class PU_ITS_SNAPSHOT_INQUIRE extends Structure {
        ...
        public BOOL bOnceInquireFlag;            //Indicates whether to display search results on one page. The value TRUE indicates that search results are displayed on one page.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITS_SIGNAL_LIGHT_AREA_PARAM extends Structure {
        ...
        public byte[] szReserve = new byte[PU_RESERVE_LEN];  //szReserve[0] indicates whether to enable drawing and szReserve[1] indicates whether to enable selection.
    ...
    public static class PU_ITS_EPOLICE_SIGNAL_LIGHT_PARAM extends Structure {
        ...
        public PU_ITS_SIGNAL_LIGHT_AREA_PARAM[] astSignalLightList = (PU_ITS_SIGNAL_LIGHT_AREA_PARAM[]) new PU_ITS_SIGNAL_LIGHT_AREA_PARAM().toArray(PU_ITS_MAX_LIGHTAREA_NUM);         //Traffic light parameters.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class tagItsEPoliceSnapType_V2 extends Structure {
        ...
        public int enRegulaSnapType;                       // Violation snapshot mode (single-shutter or dual-shutter).c type:PU_ITS_REGULA_SNAP_TYPE
        public byte[] szReserve = new byte[PU_RESERVE_EX_LEN - 4];/*PU_ITS_REGULA_SNAP_TYPE*/

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "enITSType", "enRegulaDtType", "aiMultiSnapInterval", "iRegulationNum", "astRegulationSnapCfgU", "enITSSnapIntervalType"
                    , "stAdaptSnapInterval", "enRegulaSnapType", "szReserve");
        }
    }
    ...
    public static class tagRegulationSnapConfigUnit extends Structure {
        ...
        public PU_ITS_REGULATION_CFG_ATTCH_UNIT_S uniAttach = new PU_ITS_REGULATION_CFG_ATTCH_UNIT_S();        //Additional information.
...
//                    uniAttach.setType(uniAttach.stImpolitePedestriansTime.getClass());
    ...
    public static class PU_ITS_REGULATION_CFG_ATTCH_UNIT_S extends Union {
        ...
        public PU_ITS_RUNLIGHT_PARA_S stRunningRed;       //Running-red-light snapshot parameter (ITS_REGULA_RUNNINGRED), which is a reserved field.
        public PU_ITS_REGULATION_CFG_ATTCH_PRESS_LINE_UNIT_S stPressLine;        //Marked lanes violation (ITS_REGULA_OVER_LANE_LINE).
        public PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S stInvadeDriverWay;  //Motor vehicles driving on non-motor vehicle lanes (ITS_REGULA_MOTOR_IN_BICYCLE_LANE).
        public PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S stInvadeBusLane;    //Bus lane violation (ITS_REGULA_OCCUPANCY_BUSLANE).
        public PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S stIllegalParkTime;  //Parking in yellow zones (ITS_REGULA_ILLEGAL_PARKING).
        public PU_ITS_REGULATION_CFG_ATTCH_INVADE_DRIVERWAY_UNIT_S stImpolitePedestriansTime;//Pedestrian waiting time.
        /*@Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("stRunningRed","stPressLine","stInvadeDriverWay", "stInvadeBusLane", "stIllegalParkTime","stImpolitePedestriansTime");
        }*/
    }
    ...
    public static class tagItsAdaptSnapIntervalType extends Structure {
        ...
        public int[] aiAdaptLowSpeedInterval = new int[ITS_ADAPT_SNAP_INTERVAL_NUM_MAX];  //Continuous snapshot interval in low speed scenarios, in milliseconds.
        public int[] aiAdaptMidSpeedInterval = new int[ITS_ADAPT_SNAP_INTERVAL_NUM_MAX];  //Continuous snapshot interval in medium speed scenarios, in milliseconds.
        public int[] aiAdaptHighSpeedInterval = new int[ITS_ADAPT_SNAP_INTERVAL_NUM_MAX];  //Continuous snapshot interval in high speed scenarios, in milliseconds.
    ...
    public static class PU_ITS_MANUAL_SNAPSHOT_PARA extends Structure {
        ...
        public ULONG[] aulSnapInterval = new ULONG[MAX_BURST_SHOOTING_NUM - 1];  //?????(ms) ??Χ[MIN_ITS_SNAPSHOT_INTERVAL, MAX_ITS_SNAPSHOT_INTERVAL]
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITS_EPOLICE_LANE_PARAM extends Structure {
        ...
        public int iLaneNum;                       //Lane quantity.
        public PU_ITS_LANE_PARAM_UNIT[] astLaneParamU = (PU_ITS_LANE_PARAM_UNIT[]) new PU_ITS_LANE_PARAM_UNIT().toArray(MAX_AREA_VERTEX); //Lane parameters.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ITS_LANE_INFO_BASE_UNIT extends Structure {
        ...
        public int iBindingDeviceCode;                 //Associated lane ID, used by radars, vehicle detectors, and external I/O devices.
        public int iPreRecordStart;                    //Pre-recording start time.
        public int enLaneSideScene;                    // Lane scene, which is used to determine whether an illegal U-turn occurs.c type:ITS_ROAD_SIDE_SCENE_E
    ...
    public static class PU_ITS_SPEED_LIMIT extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("iNormalSignSpeed", "iNormalLowSpeed", "iNormalHighSpeed", "iBigVehicleSignSpeed", "iBigVehicleLowSpeed",
                    "iBigVehicleHighSpeed", "szReserve"
            );
        }
    }
    ...
    public static class ROAD_PROPERTY_UNIT_S extends Structure {
        ...
        //C type : ITS_ROAD_SIDE_SCENE_E
        public int enLaneSideScene;   /*Lane scene type, which is used to determine whether an illegal U-turn occurs.*/
    ...
    public static class PU_PTZ_CURRENT_LOCATION_EX extends Structure {
        public NativeLong lPTZHorDegree;               //Horizontal angle (0° to 359°).
        public NativeLong lPTZVerDegree;               //Vertical angle (–10° to +90°).
        public ULONG ulLenMultiple;                    //Integral part of the lens zoom ratio (1–30. If the digital zoom is not 0, the lens zoom ratio is the maximum value 30 by default.).
        public ULONG ulDotLenMultiple;                 //Decimal part of the lens zoom ratio (0–99; accurate only to one decimal place).
        public ULONG ulZoomRatio;                      //Integral part of the digital zoom (0–12. The parameter is set when the lens zoom ratio reaches the maximum value. The value 0 indicates that this parameter is not set. The total zoom ratio is the multiplication of zoom ratios.)
        public ULONG ulDotZoomRatio;                   //Decimal part of the digital zoom (0–99; accurate only to one decimal place).
        public NativeLong lPTZDotHorDegree;            //Decimal part of the horizontal angle (0–99; accurate only to one decimal place).
        public NativeLong lPTZDotVerDegree;            //Decimal part of the vertical angle (–99 to +99; accurate only to one decimal place).
...
//Snapshot type.
    ...
    public static class PU_TD_ALG_PARAMS extends Structure {
        ...
        public NativeLong lPTZCalibrationHorizontal;  //PTZ calibration parameter (horizontal). The value ranges from –2 to 2.
        public NativeLong lPTZCalibrationVertical;    //PTZ calibration parameter (vertical). The value ranges from –2 to 2.
    ...
    public static class PU_TD_TOUR_PLAN_ONE_DAY_PARAMS extends Structure {
        ...
        public PU_TD_TOUR_TRACK_POINT_PARAMS[] stTourTrackPoint = (PU_TD_TOUR_TRACK_POINT_PARAMS[]) new PU_TD_TOUR_TRACK_POINT_PARAMS().toArray(TD_MAX_SCENE_NUM);//Daily tour plan.
    ...
    public static class PU_TD_TOUR_PLAN_PARAMS extends Structure {
        ...
        public PU_TD_TOUR_PLAN_ONE_DAY_PARAMS[] stTourPlanDay = (PU_TD_TOUR_PLAN_ONE_DAY_PARAMS[]) new PU_TD_TOUR_PLAN_ONE_DAY_PARAMS().toArray(TD_MAX_DAY_ONE_WEEK);   //Tour plan parameter.
    ...
    public static class PU_TD_LINE_PARAMV2 extends Structure {
        ...
        public ROAD_PROPERTY_UNIT_S[] stLane = (ROAD_PROPERTY_UNIT_S[]) new ROAD_PROPERTY_UNIT_S().toArray(TDOME_MAX_LANE_NUM);  //Number of lane lines = Number of lanes + 1
        public ROAD_PROPERTY_UNIT_S stLaneRhtBorderLine;   //Right lane boundary.
    ...
    public static class PU_TD_TRAFFIC_DOME_ILLEGAL_INTELLIGENT_PARAMS extends Structure {
        ...
        public int enIllegalType; //Parking violation type.
        public BOOL bRecordEnable;              //Indicates whether to enable the recording function. The default value is FALSE.
    ...
    public static class PU_TD_TRAFFIC_DOME_ILLEGAL_PARKINK_PARAMS extends Structure {
        ...
        public ULONG ulDetectInterval;                               //Detection interval (currently used to replace the snapshot rule).
        public PU_TD_ILLEGAL_PARKINK_SNAP_RULE stSnapRules;  // Structure discarded in the V2 API, which does not need to be set.
...
// TRAFFIC_DOME_ILLEGAL_PARKINK_PARAMS_S
    ...
    //Application parameters of traffic PTZ dome cameras (wrong-way driving detection)
    ...
    //Application parameters of traffic PTZ dome cameras (illegal U-turn detection).
    ...
    //Application parameters of traffic PTZ dome cameras (marked lanes violation detection).
    ...
    //Application parameters of traffic PTZ dome cameras (unsafe lane change detection).
    ...
    //Application parameters of traffic PTZ dome cameras (detection of motor vehicles driving on non-motor vehicle lanes).
    ...
    //Application parameters of traffic PTZ dome cameras (traffic violation evidence collection).
    public static class PU_TD_TRAFFIC_DOME_ILLEGAL_EVIDENCE_PARAMS extends Structure {
        public PU_TD_TRAFFIC_DOME_ILLEGAL_PARKINK_PARAMS stIllegalParkingParams;   //Parking violation detection parameter.
        ...
        public PU_TD_TRAFFIC_DOME_MOTOR_IN_BICYCLE_LANE_PARAMS stMiBLaneParams;   //Snapshot rule for detection of motor vehicles driving on non-motor vehicle lanes.
    ...
    //Application parameters of traffic PTZ dome cameras (pedestrian detection parameters).
    ...
    //Application parameters of traffic PTZ dome cameras (congestion detection parameters).
    public static class PU_TD_TRAFFIC_DOME_TRAFFIC_EVENT_CONGESTION_DT_PARAMS extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("bEnable", "ulSensitivity", "ulContinuousDuration", "ulFilterDuration", "abRelatedLane");
        }
    }
    ...
    public static class PU_TD_SCENE_APP_PARAMSV2 extends Structure {
        ...
        public PU_TD_ILLEGAL_PARKINK_PARAMS stIllegalParking;   //This parameter is not used and is for compatibility with old devices.
        public PU_TD_TRAFFIC_DOME_ILLEGAL_EVIDENCE_PARAMS stIllegalEviParams; //Violation evidence collection parameter.
        public PU_TD_TRAFFIC_DOME_TRAFFIC_EVENT_PARAMS stTrafficEventParams; //Traffic event parameter.
        public PU_TD_TRAFFIC_DOME_TRAFFIC_DATA_COLLECT_PARAMS stTrafficDataCollectParams; //Traffic data collection parameter.
    ...
    public static class PU_MASTER_SLAVE_PER_GROUP_PARA extends Structure {
        ...
        public ULONG ulGroupID; //ID of the master/slave device association. This parameter is reserved and is not used currently.
    ...
    public static class PU_MASTER_SLAVE_LOCATE_PARA extends Structure {
        /**
         * ID of the master/slave device association. This parameter is reserved and is not used currently.
         */
        public NativeLong ulGroupID;
        /**
         * Master and slave camera locating type.
        ...
        /**
         * @param ulGroupID ID of the master/slave device association. This parameter is reserved and is not used currently.<br>
    ...
    public static class PU_ITS_RESTRICTED_PARAM extends Structure {
        ...
        public PU_ITS_RESTRICTED_PARA_UNIT[] astRestricteds = (PU_ITS_RESTRICTED_PARA_UNIT[]) new PU_ITS_RESTRICTED_PARA_UNIT().toArray(MAX_RESTRICTED_EVENT_NUM);     //尾号限行项总数
        public byte[] szReserved = new byte[PU_RESERVE_EX_LEN];
    ...
    public static class PU_ITS_RESTRICTED_PARA_UNIT extends Structure {
        ...
        public WinDef.BOOL[] abRestrictedNum = new WinDef.BOOL[MAX_RESTRICTED_NUM];  /* End number that is restricted. The value ranges from 0 to 9.*/
        public PU_ITS_RESTRICTED_DATA stRestrictedDate;       //Restricted date and time segment.
        public PU_ITS_RESTRICTED_REGION[] astLocalPlate = (PU_ITS_RESTRICTED_REGION[]) new PU_ITS_RESTRICTED_REGION().toArray(MAX_RESTRICTED_LOCALPLATE_NUM);  //Local license plate.
        public WinDef.BOOL[] abLocalRestrictedNum = new WinDef.BOOL[MAX_RESTRICTED_NUM];                            //Local end number that is restricted. The value ranges from 0 to 9.
        public WinDef.BOOL[] abNonLocalRestrictedNum = new WinDef.BOOL[MAX_RESTRICTED_NUM];                         //External end number that is restricted. The value ranges from 0 to 9.
    ...
    public static class PU_ITS_RESTRICTED_DATA extends Structure {
        ...
        public int enIndexType;         //Index mode, by date end number or by weekday. C type is PU_ITS_RESTRICTED_INDEX_TYPE_E
        public WinDef.BOOL[] abRestrictedU = new WinDef.BOOL[MAX_RESTRICTED_DATE_NUM]; //Indicates whether to enable the end-number policy. If the end-number policy is implemented by weekday, there are seven options. If the end-number policy is implemented by date end number, there are 10 options.
    ...
    public static class PU_VLPR_TRAFFIC_STATISTICS extends Structure {
        ...
        public ULONG uCongestionLaneThreshold; //Minimum number of congested lanes. When the number of congested lanes is greater than or equal to the threshold, the road is determined as congested.
    ...
    public static class PU_HOTMAP_PARA extends Structure {
        ...
        // C type : PU_ENABLE_TYPE_E
        public int enSendMeta;        //Indicates whether to enable the function of sending metadata. This function is enabled by default.
    ...
    public static class PU_AUTO_CALIBRATION_CONFIG extends Structure {
        ...
        public byte[] szMasterScreenPicPath = new byte[PU_SNAPSHOT_PICTURE_NAME_LEN]; //Path for storing snapshots taken by the PTZ dome camera.
        public byte[] szSlaveScreenPicPath = new byte[PU_SNAPSHOT_PICTURE_NAME_LEN]; //Path for storing snapshots taken by the slave camera.
    ...
    public static class PU_HOTMAP_GUARD_PLAN_PARA_S extends Structure {
        ...
        public PU_HOTMAP_TIME_PLAN[] astGuadTime = (PU_HOTMAP_TIME_PLAN[]) new PU_HOTMAP_TIME_PLAN().toArray(PU_DAY_NUM_PER_WEEK); //Weekly alert plan.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_HOTMAP_TIME_PLAN extends Structure {
        ...
        public PU_TIME_PLAN_PER_DAY[] astTimePalnPerDay = (PU_TIME_PLAN_PER_DAY[]) new PU_TIME_PLAN_PER_DAY().toArray(PU_GUARD_PLAN_NUM_PER_DAY); //Time period of a daily alert plan.
    ...
    public static class PU_HOTMAP_TABLE_PARA extends Structure {
        ...
        public PU_TIME_S stBeginTime;
        /**
         * Report file storage path, which is defined by the invoker.
         * C type : CHAR[128 + 1]
         */
        ...
        public PU_HOTMAP_TABLE_PARA(NativeLong ulChannelId, int enHotmapType, int enTableType, PU_TIME_S stBeginTime, byte szPath[], hotMapTable_union hotMapTable, byte szReserved[]) {
            super();
    ...
    public static class PU_ITGT_VHD_AUTO_TRACK_PARA extends Structure {
        ...
        public PU_ITGT_VHD_OBJECT_ITEM[] objItem = (PU_ITGT_VHD_OBJECT_ITEM[]) new PU_ITGT_VHD_OBJECT_ITEM().toArray(PU_ITGT_AUTOTRACKING_PRIORITY_ITEM_NUM);   //Automatic tracking priority.
        public byte[] szReserved = new byte[PU_RESERVE_EX_LEN];
    ...
    public static class PU_ALARM_TIME_LIST_S extends Structure {
        ...
        public ULONG ulNum;                                                    //Number of alert deployment time segments.
        public PU_ALARM_TIME_S[] stAlarmTime = (PU_ALARM_TIME_S[]) new PU_ALARM_TIME_S().toArray(PU_ALARM_TIME_MAX);                 //Alert deployment time segment array.
    ...
    public static class PU_FACE_OSD_INFO extends Structure {
        ...
        // Foreground (text) transparency, ranging from 0 to 128; not supported currently.
        public WinDef.UCHAR ucFgAlpha;
        //Background color format: 0xRRGGBB or converted into decimal.
        public NativeLong ulBgColor;
        // Background transparency, ranging from 0 to 128 (HiSilicon); not supported currently.
    ...
    public static class LPPU_CONFIG_JSON_INPUT_ST extends Structure {
        ...
        public ULONG ulRecvTimeOut;    //Receiving timeout duration, in milliseconds. The value 0 indicates the default timeout duration 5s.
    ...
    public static class LPPU_CONFIG_JSON_CONFIG_OUTPUT_ST extends Structure {
        ...
        public Pointer pOutBuffer;       //Output parameter buffer, in JSON format. Note: The application layer must apply for sufficient memory. If the memory is insufficient, the API returns the corresponding error code.
    ...
    public static class META_HUMAN_ATTRIBUTES_S extends Structure {
        ...
        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("isVaild", "age", "gender", "upperStyle", "upperColor", "upperTexture",
                    "lowerStyle", "lowerColor", "shape", "mouthmask", "hair", "backpack", "carry", "satchel", "umbrella", "frontpack",
    ...
    public interface FACE_DT_CAP_MODE_E {
        int FACE_CAP_DEFAULT_MODE = 0; //Default snapshot mode. A snapshot is taken after the object leaves the surveillance view.
    ...
    public static class PU_FACE_DETC_DL_PARA_S extends Structure {
        ...
        public BOOL bSensitivityFlage;            //Quality sensitivity switch, corresponding to the preceding face/person image quality filtering sensitivity.
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("bEnable", "ulAlarmTime", "ulSensitivity", "ulFaceSensitivity", "ulBodySensitivity", "ulFaceKpsSensitivity", "ulBodyKpsSensitivity",
                    "ulMinPupilDist", "ulMaxPupilDist", "enMode", "bFaceExposure", "ulROIMeterLevel", "enFaceCapMode", "ulFaceCapSensitivity", "uchFaceExposureTime", "bSensitivityFlage", "szReserved");
        }
    }
    ...
    public static class PU_FACE_DETC_PARA_S extends Structure {
        ...
        public BOOL bEnable;              //Indicates whether to enable snapshot retransmission.
        public ULONG ulSensitivity;        //Detection sensitivity.
        public ULONG ulMinDectFace;        //Minimum face size that can be detected. The value ranges from 66 to 486 pixels. It is recommended that the minimum face width be 70 pixels and the maximum face width be 180 pixels in distant view mode. It is recommended that the minimum face width be 131 pixels and the maximum face width be 273 pixels in close-up view mode.
        public ULONG ulMaxDectFace;        //Maximum face that can be detected. The value ranges from 66 to 486 pixels. It is recommended that the minimum face width be 70 pixels and the maximum face width be 180 pixels in distant view mode. It is recommended that the minimum face width be 131 pixels and the maximum face width be 273 pixels in close-up view mode.
        public ULONG ulDectMode;           //Detection mode. The options are as follows: 0 distant view mode; 1: close-up view mode.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_FACE_TRACKING_PARAMETER_S extends Structure {
        public BOOL bFilter;               //Indicates whether to enable the tracking correction mode (also called detection error filtration).
    ...
    public static class PU_FACE_PROCESS_PARAM_S extends Structure {
        ...
        public byte[] szReserved = new byte[PU_RESERVE_LEN];   //szReserved[0] indicates the number of face images. The value ranges from 1 to 5. The default value is 1.

        //szReserved[1] indicates image enhancement.
        //szReserved[2] indicates the face image quality. The value ranges from 1 to 10. The default value is 10.
        //szReserved[3] indicates the full image quality. The value ranges from 1 to 10. The default value is 5.
        //szReserved[4] indicates whether to enable facial attribute recognition.
        //szReserved[5] indicates whether to enable face detection error filtration. The options are 0 (no) and 1 (yes).
        //szReserved[6] indicates the face detection error filtration sensitivity. The value ranges from 1 to 10. The default value is 5.
    ...
    public static class PU_TW_ALARM_PARA extends Structure {
        ...
        public PU_IGT_TW_LINE_LIST_S stlineList;       /*Tripwire list: When you obtain the tripwire list, the coordinates of all tripwires are returned. If the tripwire coordinates are 0, the tripwire is out of the camera's surveillance range (an index is returned).*/
        /*This parameter is optional. If ulLineNum is not set to 0, all tripwires are delivered. If ulLineNum is set to 0, no tripwire is delivered.*/
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "bEnable", "ulAlarmInterval", "enTargetDetecMode", "stlineList", "stTWGuardPlan", "ulSensitivity", "szReserved");
        }
    }
    ...
    public static class PU_IGT_AEREDTC_ALARM_PARA extends Structure {
        ...
        public PU_IGT_AERADTC_LIST_S stAreaDtcList;    //Area list: When you obtain the area list, the coordinates of all areas are returned. If the area coordinates are 0, the area is out of the camera's surveillance range (an index is returned).
        //This parameter is optional. If ulAreaNum is not set to 0, all areas are delivered. If ulAreaNum is set to 0, no area is delivered.
    ...
    public static class PU_IGT_ALARM_PARA extends Structure {
        ...
        //szReserved[1] indicates the minimum object height (5–200 pixels and smaller than the maximum height).
    ...
    public static class PU_TEMPERATURE_ALARM_PARA extends Structure {
        ...
        public NativeLong lEnable;                           //Indicates whether to enable the ROI.
        public ULONG ulDeteInterval;                   //Alarm check interval (1–256s). The system checks the alarm status at a specified interval.
    ...
    public static class PU_GUARD_STATE extends Structure {
        ...
        public PU_GUARD_PARA[] szChannelStateList = new PU_GUARD_PARA[PU_CAMERA_NUM_MAX];          //Alert deployment status. The parameter is invalid when the value of ulDeviceId is 0.
        public PU_GUARD_PARA[] szInputStateList = new PU_GUARD_PARA[PU_DIO_NUM_MAX];               //Alarm status of the input device. The parameter is invalid when the value of ulDeviceId is 0.
        public byte[] szReserve = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_ALARM_LINKAGE_PARA extends Structure {
        ...
        public PU_ALARM_LINKAGE_CAMERA_INFO[] stCameraList = new PU_ALARM_LINKAGE_CAMERA_INFO[PU_ALARM_CAMERA_MAX]; //Linked camera information list.
        public ULONG[] szDoIdList = new ULONG[PU_ALARM_DO_MAX];                              //Linked Boolean value output ID.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];                                //szReserved[0]: Indicates whether to link email sending. The options are as follows: 0: no; 1: yes.
    ...
    public static class PU_ALARM_LINKAGE_CAMERA_INFO extends Structure {
        ...
        public NativeLong lHorizontalScan; //The options are as follows: 0: invalid; 1 to 10: forward scanning speed level; -1 to -10: backward scanning speed level.
        ...
        public NativeLong lPanormaScan;    //The options are as follows: 0: invalid; 1 to 10: forward scanning speed level; -1 to -10: backward scanning speed level.
        public ULONG ulVerticalScan;  //The options are as follows: 0: invalid; 1 to 10: scanning speed level.
        public BOOL bMailSend;       //Indicates whether to link email sending. The options are as follows: 0: no; 1: yes.

        @Override
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChannelId", "ulPreId", "ulCruiseId", "ulRecord", "ulSnap", "ulSnapInterval", "ulDesignScan",
                    "lHorizontalScan", "ulFrameScan", "ulRandomScan", "lPanormaScan", "ulVerticalScan", "bMailSend");
        }
    }
    ...
    public static class PU_INPUT_ALARM_PARA extends Structure {
        ...
        public NativeLong lEnable;                           //Indicates whether to enable the ROI.
        public ULONG ulType;                           //Boolean value output status. The options are as follows: 0: normally open; 1: normally close.
        public ULONG ulDeteInterval;                   //Alarm check interval (1–256s). The system checks the alarm status at a specified interval.
    ...
    public static class PU_ALARM_TIME_LIST extends Structure {
        ...
        public ULONG ulNum;                                                    //Number of alert deployment time segments.
        public PU_ALARM_TIME[] stAlarmTime = new PU_ALARM_TIME[PU_ALARM_TIME_MAX];                 //Alert deployment time segment array.
    ...
    public static class PU_MOTION_DETECTION_PARA extends Structure {
        ...
        public NativeLong lEnable;                           //Indicates whether to enable the ROI.
        public ULONG ulInterval;                       //Interval for detecting events. The value ranges from 1 to 30, in seconds. Motions detected in the interval are considered as the same motion.
        public ULONG ulSensitivity;                    //Motion detection sensitivity. The value ranges from 1 to 5. A larger value indicates a higher sensitivity.
        public ULONG ulDeteInterval;                   //Alarm check interval (1–256s). The system checks the alarm status at a specified interval.
    ...
    public static class PU_SWITCH_OUTPUT_STATE extends Structure {
        public ULONG ulOutputId;
        public ULONG ulSwitchType;                    //Boolean value output status. The options are as follows: 0: normally open; 1: normally close.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_PIC_OSD_PARA_V2_S extends Structure {
        ...
        public PU_CUSTOM_OSD_PARA_S stDirOSDPara;      //Direction OSD.
        public PU_CUSTOM_OSD_PARA_S stCustomOSDPara;   //Customized OSD.
        public BOOL bDirOSDParaEn;      //Indicates whether to enable or disable driving direction OSD. The value 1 indicates that driving direction OSD is disabled (ITS cameras). The value 0 indicates driving direction OSD is enabled.
        public byte[] szReserved = new byte[PU_RESERVE_LEN];
    ...
    public static class PU_PIC_OSD_PARA_V3_S extends Structure {
        ...
        protected List<String> getFieldOrder() {
            return Arrays.asList("ulChnID", "enOverlayPicType", "stPicOSDInfo", "stTimeOSDPara", "stRoadIdOSDPara", "stDevIdOSDPara", "stDirIdOSDPara", "stDirOSDPara", "stCustomOSDPara", "stLocateDescOSDPara", "stMonitorInfoOSDPara", "stLaneDescOSDPara", "stLaneDirDescOSDPara", "bDirOSDParaEn", "szReserved");
        }
    }
    ...
    public static class PU_PIC_SYNTHESIS_PARA_V3_S extends Structure {
        ...
        //Member variables used in earlier versions (forward compatible). // Suspended in the new version.
    ...
    public static class PU_PIC_SYNTHESIS_PARA_V2_S extends Structure {
        ...
        public BOOL bFaceSynthesisEnable;        //Indicates whether to enable face synthesis.
        public PU_FACE_SYN_SCALE_TYPE_E enFaceSynthesisScale;    //Size of a face cutout.
        public byte[] szReserved = new byte[PU_RESERVE_LEN - (LLong.size * PU_ITS_PIC_SYNTHESIS_TYPE.ITS_TYPE_PIC_SYNTHESIS_MAX) - 4 - 4];
    ...
    public interface PU_TWO_PIC_SYNTHESIS_TYPE_E {
        ...
        int PU_TWO_PIC_SYNTHESIS_TYPE3 = 2;     //Up-and-down arrangement of three images (including one close-up image), with the close-up image at the top.
        int PU_TWO_PIC_SYNTHESIS_TYPE4 = 3;     //Up-and-down arrangement of three images (including one close-up image), with the close-up image at the bottom.
        int PU_TWO_PIC_SYNTHESIS_TYPE5 = 4;     //Left-and-right arrangement of three images (including one close-up image), with the close-up image at the leftmost.
        int PU_TWO_PIC_SYNTHESIS_TYPE6 = 5;     //Left-and-right arrangement of three images (including one close-up image), with the close-up image at the rightmost.
        int PU_TWO_PIC_SYNTHESIS_TYPE7 = 6;     //Arrangement of three images (including one close-up image) in triangle mode, with the close-up image at the top.
        int PU_TWO_PIC_SYNTHESIS_TYPE8 = 7;     //Arrangement of three images (including one close-up image) in triangle mode, with the close-up image at the bottom.
        int PU_TWO_PIC_SYNTHESIS_TYPE9 = 8;     //Arrangement of three images (including one close-up image) in triangle mode, with the close-up image at the leftmost.
        int PU_TWO_PIC_SYNTHESIS_TYPE10 = 9;    //Arrangement of three images (including one close-up image) in triangle mode, with the close-up image at the rightmost.
    ...
    public interface PU_THREE_PIC_SYNTHESIS_TYPE_E {
        ...
        int PU_THREE_PIC_SYNTHESIS_TYPE3 = 2;     //Up-and-down arrangement of three images and one close-up image in cross mode, with the close-up image at the upper left.
        int PU_THREE_PIC_SYNTHESIS_TYPE4 = 3;     //Up-and-down arrangement of three images and one close-up image in cross mode, with the close-up image at the upper right.
        int PU_THREE_PIC_SYNTHESIS_TYPE5 = 4;     //Up-and-down arrangement of three images and one close-up image in cross mode, with the close-up image at the lower left.
        int PU_THREE_PIC_SYNTHESIS_TYPE6 = 5;     //Up-and-down arrangement of three images and one close-up image in cross mode, with the close-up image at the lower right.
        int PU_THREE_PIC_SYNTHESIS_TYPE7 = 6;     //Arrangement of three images in triangle mode, with the second image at the top.
        int PU_THREE_PIC_SYNTHESIS_TYPE8 = 7;     //Arrangement of three images in triangle mode, with the second image at the bottom.
    ...
    public interface PU_COMBINE_TYPE_E {
        ...
        //If an enumeration value of the single-image synthesis mode needs to be added, the value starts from 50.

        //If an enumeration value of the two-image synthesis mode needs to be added, the value starts from 100.
        int PU_COMB_DOUBLE_PYRAMIDAL_TOP_ADAPT = 100; /*Two snapshots with close-up, inverted-triangle synthesis size.*/
        int PU_COMB_DOUBLE_PYRAMIDAL_BUTT_ADAPT = 101; /*Two snapshots with close-up, inverted-triangle synthesis size.*/
        int PU_COMB_DOUBLE_PYRAMIDAL_LEFT_ADAPT = 102; /*Two snapshots with close-up, leftward triangle synthesis size.*/
        int PU_COMB_DOUBLE_PYRAMIDAL_RIGHT_ADAPT = 103; /*Two snapshots with close-up, rightward triangle synthesis size.*/

        //If an enumeration value of the three-image synthesis mode needs to be added, the value starts from 150.
        int PU_COMB_TREBLE_PYRAMIDAL_TOP_ADAPT = 150; /*Three snapshots without close-up, triangle synthesis size.*/
        int PU_COMB_TREBLE_PYRAMIDAL_BUTT_ADAPT = 151; /*Three snapshots without close-up, inverted-triangle synthesis size.*/
        int PU_COMB_TREBLE_PYRAMIDAL_LEFT_ADAPT = 152; /*Three snapshots without close-up, leftward triangle synthesis size.*/
        int PU_COMB_TREBLE_PYRAMIDAL_RIGHT_ADAPT = 153; /*Three snapshots without close-up, rightward triangle synthesis size.*/
    ...
    public interface PU_COMBINE_IMG_ROI_E {
        ...
        int PU_COMBINE_IMGS_ROI = 7; /*Close-up image. The specific close-up image is determined by the intelligent service.*/
    ...
    public static class PU_PTZ_SPEED_S extends Structure {
        public PU_PTZ_GEAR_SPEED_S[] stPtzGearSpeed = (PU_PTZ_GEAR_SPEED_S[]) new PU_PTZ_GEAR_SPEED_S().toArray(PU_PTZ_GEAR_NUM_MAX);
    ...
    //logout from device
    int IVS_PU_Logout(ULONG ulIdentifyID);
    ...
    //get device log info
    boolean IVS_PU_GetDeviceLogInfo(NativeLong ulIdentifyID, PU_LOG_TYPE enLogType, LPPU_LOG_REQ_PARA_S pstLogReqPara, LPPU_LOG_INFO_S pstDeviceLogInfo);
    ...
    //Device name that contains a maximum of 28 bytes (including the backslash and 0).
    ...
    boolean IVS_PU_UpgradeWithSchedule(NativeLong ulIdentifyID, LPPU_UPGRADE_FILE_INFO_S pstFileInfo, pfUpgradeScheduleCallBack fScheduleCallBack, Pointer pUsrData);
    ...
    boolean IVS_PU_WriteLogToFile(NativeLong ulLogEnable, String szFileName, NativeLong ulFileNum, NativeLong ulSizePerFile);
    ...
    boolean IVS_PU_SetConfigFile(NativeLong ulIdentifyID, byte[] szConfigFile, String pszUserName, String pszPasswd, String pszLoadUpKey);

    //802.1X certificate import and export.
    //szCertFileFirst length is PU_CONFIG_FILE_PATH_MAX=512。
    boolean IVS_PU_SetDot1xTlsCert(NativeLong ulIdentifyID, byte[] szCertFileFirst[], byte[] szCertFileSecond[], PU_DOT1X_TLS_CERT_UPLOAD_S stDot1xTlsCert);

    //Certificate validity period.
    boolean IVS_PU_GetCertExpirePeriodPara(NativeLong ulIdentifyID, PU_CERT_EXPIRE_PERIOD_PARA_S pstCertExpirePeriodPara);

    boolean IVS_PU_SetCertExpirePeriodPara(NativeLong ulIdentifyID, PU_CERT_EXPIRE_PERIOD_PARA_S pstCertExpirePeriodPara);
    ...
    boolean IVS_PU_PingIPLocal(NativeLong ulStartIP, NativeLong ulEndIP, NativeLong ulNeedNum, NativeLong out_pIPList, NativeLong out_pulIPNum);

    //change device IP address by MAC
    boolean IVS_PU_ModifyIPByLocalMac(String szSrcNetMac, String szDstMac, String szPwd, String szDstIP, String szMask, String szGateway);

    //search device list info by UDP connect
    boolean IVS_PU_DiscoveryDeviceByIpAddresses(String pszStartIpAddr, String pszEndIpAddr, NativeLong ulSearchNum, PU_DISCOVER_DEVICE_INFO_S[] pszDeviceList, LongByReference pulDeviceNum);

    //change device password
    boolean IVS_PU_ChangeDevicePassword(NativeLong ulIdentifyID, String pszUserName, String pszOldPasswd, String pszNewPasswd);

    //change destination module admin password
    //enDstModule -> C type:IPC_MODULE
    boolean IVS_PU_ChangeAdminPassword(NativeLong ulIdentifyID, String pszOldPasswd, String pszNewPasswd, int enDstModule);
    ...
    boolean IVS_PU_SetChannelStreamProfilesParaV2(NativeLong ulIdentifyID, PU_CHANNEL_STREAM_PROFILESV2 stStreamProfile);
    ...
    public int IVS_PU_H264DecAU(WinDef.HWND pH264Handle, WinDef.UCHAR pucStream, WinDef.UINT iStreamLen, long ullPTS, WinDef.UINT iFlags, PU_H264_DEC_FRAME pstDecFrame);
    ...
    public boolean IVS_PU_GetSlaveDeviceOnvifStatus(WinDef.ULONG ulIdentifyID, PU_SLAVE_ONVIF_STATUS_S pstSlaveOnvifStatus);

    //Obtain the RTSP status of slave cameras.
    public boolean IVS_PU_GetSlaveDeviceRtspStatus(WinDef.ULONG ulIdentifyID, PU_SLAVE_RTSP_STATUS_S pstSlaveRtspStatus);
    ...
    //Obtain information about the master and slave channels in master-slave camera surveillance mode.
    ...
    //enCharEncodeType -> C type:PU_CHAR_ENCODE_TYPE
    boolean IVS_PU_GetOsdTextExV2(ULONG ulIdentifyID, PU_OSD_STRING_ARRAY_EX_OUT pstOsdPartcularPara, int enCharEncodeType);

    boolean IVS_PU_SetOsdTextExV2(ULONG ulIdentifyID, PU_OSD_STRING_ARRAY_EX_OUT pstOsdPartcularPara, int enCharEncodeType);
    ...
    boolean IVS_PU_GetWaterMark(ULONG ulIdentifyID, ULONG ulChannelId, int enStreamType, WinDef.BOOLByReference pbWaterMarkEnable);

    //get device record info
    boolean IVS_PU_GetRecordInfoList(ULONG ulIdentifyID, PU_RECORD_INQUIRE pstRecordInquire, PU_RECORD_LIST pstRecordList);

    boolean IVS_PU_GetRecordInfoListByUTC(ULONG ulIdentifyID, PU_RECORD_INQUIRE pstRecordInquire, PU_RECORD_LIST pstRecordList);

    boolean IVS_PU_GetAlarmRecInfoList(ULONG ulIdentifyID, PU_ALARM_REC_INQ_REQ pstAlarmRecInqReq, PU_ALARM_REC_INQ_RSP pstAlarmRecInqRsp);
    ...
    boolean IVS_PU_GetStreamLayerCodeMode(ULONG ulIdentifyID, ULONG ulChannelId, int enStreamType, WinDef.BOOLByReference pbEnable);

    //set device stream function params
    //enPURecordStream & enPlatRecordStream -> C Type:PU_STREAM_TYPE
    boolean IVS_PU_SetStreamFunctionPara(ULONG ulIdentifyID, ULONG ulChannelId, int enPURecordStream, int enPlatRecordStream);
    ...
    boolean IVS_PU_StartSnapShot(ULONG ulIdentifyID, ULONG ulChannelId, ULONG ulSnapCount, ULONG ulSnapInterval, int enSnapType);
    ...
    boolean IVS_PU_GetSnapshotPicList(ULONG ulIdentifyID, PU_SNAPSHOT_INQUIRE_S pstSnapshotInquire, PU_SNAPSHOT_LIST_S pstSnapshotList);
    ...
    //Indicates whether the ONVIF message validity period expiration function is enabled.
    ...
    boolean IVS_PU_GetRecordUploadBandwidth(ULONG ulIdentifyID, WinDef.BOOLByReference pbEnable, LongByReference pulMaxUploadRate);  //----->Num.200
    ...
    //Obtain the value of the parameter for uploading snapshots through FTP or SFTP.
    ...
    //Adjust the focus for an ABF camera (moving towards FAR or NEAR). After the adjustment, the focus is not automatically focused.
    ...
    public int IVS_PU_RealPlay_V20(ULONG ulIdentifyID, PU_REAL_PLAY_INFO_V20.ByReference pstRealPlayInfo, PU_MEDIA_ENC_PARA_S.ByReference pstMediaEncPara, pfRealDataCallBack fRealDataCallBack, Pointer pUsrData);
    ...
    //voice talk back
    public ULONG IVS_PU_StartVoiceTB(ULONG ulIdentifyID, PU_VOICE_INFO pstVoiceTBInfo, pfVoiceTBCallBack fVoiceTBCallBack, Pointer pUsrData);
    ...
    //media signal
    boolean IVS_PU_MediaPlay(ULONG ulIdentifyID, PU_MEDIA_PLAY_INFO pstMediaPlayReqInfo, PU_MEDIA_PLAY_RSP pstMediaPlayRspInfo);

    boolean IVS_PU_MeidaPlayAck(ULONG ulIdentifyID, ULONG ulSessionId, ULONG ulVideoPayload, ULONG ulAudioPayload, ULONG ulIgtPayload);

    boolean IVS_PU_MeidaStop(ULONG ulIdentifyID, ULONG ulSessionId);

    //New API whose function is the same as that of IVS_PU_MeidaPlayAck and IVS_PU_MeidaStop.
    boolean IVS_PU_MediaPlayAck(ULONG ulIdentifyID, ULONG ulSessionId, ULONG ulVideoPayload, ULONG ulAudioPayload, ULONG ulIgtPayload);
    ...
    boolean IVS_PU_GetWDR(ULONG ulIdentifyID, ULONG ulChannelId, IntByReference penSwitchMode, LongByReference pulAutoType, LongByReference pulSensitivity);

    boolean IVS_PU_SetWDR(ULONG ulIdentifyID, ULONG ulChannelId, int enSwitchMode, ULONG ulAutoType, ULONG ulSensitivity);
    ...
    boolean IVS_PU_GetBlazeRestrain(ULONG ulIdentifyID, ULONG ulChannelId, WinDef.BOOLByReference pbEnable, LongByReference pulBlazeRestrainLevel);

    boolean IVS_PU_SetBlazeRestrain(ULONG ulIdentifyID, ULONG ulChannelId, WinDef.BOOL bEnable, ULONG ulBlazeRestrainLevel);
    ...
    boolean IVS_PU_GetNoiseReductionMode(ULONG ulIdentifyID, ULONG ulChannelId, WinDef.BOOLByReference pbEnable, LongByReference pulCoefficient);

    boolean IVS_PU_SetNoiseReductionMode(ULONG ulIdentifyID, ULONG ulChannelId, WinDef.BOOL bEnable, ULONG ulCoefficient);
    ...
    long IVS_PU_RecvTransChnDataStart(ULONG ulIdentifyID, ULONG ulSerialPort, pfTransChnDataCallBack pfTransChnCBFunc, Pointer pUserData);
    ...
    //device ptz aux mode   enAuxMode C type is PU_PTZ_AUX_MODE, penAuxMode c Type is PU_PTZ_AUX_MODE*
    ...
    //device ptz focus mode  penFocusMode C type is PU_FOCUS_MODE* , enFocusMode C type is PU_FOCUS_MODE
    ...
    boolean IVS_PU_AlarmInfoStatesCallBack(ULONG ulIdentifyID, pfGetAlarmInfoCallBack fAlarmResportCallBack, Pointer pUsrData);
    ...
    boolean IVS_PU_AlarmInfoStatesCallBack_V20(ULONG ulIdentifyID, pfGetAlarmInfoCallBack_V20 fAlarmResportCallBack, Pointer pUsrData);
    ...
    // enAlarmType type : PU_ALARM_TYPE
    boolean IVS_PU_GetAlarmLinkagePara(ULONG ulIdentifyID, int enAlarmType, ULONG ulAlarmId, PU_ALARM_LINKAGE_PARA pstAlarmLinkagePara);

    boolean IVS_PU_SetAlarmLinkagePara(ULONG ulIdentifyID, int enAlarmType, ULONG ulAlarmId, PU_ALARM_LINKAGE_PARA pstAlarmLinkagePara);

    //Pedestrian and vehicle separation.
    //The function interface does not expire. However, due to memory reasons, some models does not support object (people, vehicles, and articles) separation. The details are as follows:
    //(1) Color extraction: Other models except IPC6125-WDL-Fb, IPC6126-WDL-E, IPC6224-VRZ-B, IPC6325-WD-VRZ-B, IPC6256-VRZ, and IPC6355-VRZ do not support this function. The default value of the color parameter is 0.
    //(2) Object separation:
    //(1) C series: Other models except IPC6125-WDL-Fb, IPC6126-WDL-E, IPC6224-VRZ-B, IPC6325-WD-VRZ-B, IPC6256-VRZ, and IPC6355-VRZ do not support this function. The default value of the color parameter is 0.
    //(2) X series and M series do not support object separation. The default value of the color parameter is 0.
    ...
    boolean IVS_PU_GetIgtAreaDtcAlarmPara(ULONG ulIdentifyID, int enAlarmAeraType, PU_IGT_AEREDTC_ALARM_PARA pstIgtAreaDtcAlarmPara);

    boolean IVS_PU_SetIgtAreaDtcAlarmPara(ULONG ulIdentifyID, int enAlarmAeraType, PU_IGT_AEREDTC_ALARM_PARA pstIgtAreaDtcAlarmPara);

    boolean IVS_PU_IgtAreaItem(ULONG ulIdentifyID, PU_IGT_AREA_ITEM pstAreaItem);

    //This API is the face detection interface. It is applicable to all models earlier than V500R019C20 and C series cameras later than V500R019C20.
    //To invoke this function on camera models of V500R019C20 and later versions, use IVS_PU_GetAlarmPara and IVS_PU_SetAlarmPara (alarm type: PU_ALARM_TYPE_FD_DL).
    ...
    //Set the parameter for sending 3559 facial recognition metadata in anonymous mode.
    boolean IVS_PU_GetFaceRecogDLAnonymousPara(ULONG ulIdentifyID, PU_FACE_RECOGNITION_DL_ANONYMOUS_PARA_S pstFaceRecogDLAnonymous);

    boolean IVS_PU_SetFaceRecogDLAnonymousPara(ULONG ulIdentifyID, PU_FACE_RECOGNITION_DL_ANONYMOUS_PARA_S pstFaceRecogDLAnonymous);
    ...
    boolean IVS_PU_MatrixSendDataEx(ULONG ulPassiveHandle, String pSendBuf, ULONG ulBufSize, ULONG ulType, ULONG ulFrameRate);

    //Obtain the actual OSD information, enCharEncodeType C type is PU_CHAR_ENCODE_TYPE_E
    boolean IVS_PU_GetRealOsdText(ULONG ulIdentifyID, PU_OSD_PARTICULAR_PARA_EX_OUT_S pstRealOsdPara, int enCharEncodeType);
    ...
    //Set the parameter for uploading images captured by a micro checkpoint camera in FTP mode.
    boolean IVS_PU_SetVLPRFTPFileUploadPara(ULONG ulIdentifyID, PU_VLPR_FTP_UPLOAD_PARA_S pstFTPFileUpload);

    //Obtain the value of the parameter for uploading images captured by a micro checkpoint camera in FTP mode.
    boolean IVS_PU_GetVLPRFTPFileUploadPara(ULONG ulIdentifyID, PU_VLPR_FTP_UPLOAD_PARA_S pstFTPFileUpload);

    //Set the extended parameter for uploading images captured by a micro checkpoint camera in FTP mode.
    boolean IVS_PU_SetVLPRFTPFileUploadParaV2(ULONG ulIdentifyID, PU_VLPR_FTP_UPLOAD_PARA_V2_S pstFTPFileUpload);

    //Obtain the value of the extended parameter for uploading images captured by a micro checkpoint camera in FTP mode.
    ...
    boolean IVS_PU_GetITSSnapshotPicList(ULONG ulIdentifyID, PU_ITS_SNAPSHOT_INQUIRE pstSnapshotInquire, PU_SNAPSHOT_LIST_S pstSnapshotList);
    ...
    //Obtain the value of the detailed snapshot parameter or ISP parameter of the micro checkpoint camera.
    boolean IVS_PU_GetSnapshotParticularPara(ULONG ulIdentifyID, PU_SNAPSHOT_PARTICULAR_PARA_S pstSnapshotPara);

    //Set the detailed snapshot parameter or ISP parameter of the micro checkpoint camera.
    boolean IVS_PU_SetSnapshotParticularPara(ULONG ulIdentifyID, PU_SNAPSHOT_PARTICULAR_PARA_S pstSnapshotPara);

    //ITS manual snapshot (searching for snapshots triggered through intelligent analysis).
    ...
    boolean IVS_PU_SetAlarmEnventCallBack(ULONG ulIdentifyID, pfGetDevAlarmInfoCallBack fDevAlarmResportCallBack, Pointer pUsrData);
    ...
    boolean IVS_PU_ItgtUpgradeWithSchedule(ULONG ulIdentifyID, PU_UPGRADE_ITGT_FILE_INFO pstItgtFileInfo, pfUpgradeScheduleCallBack fScheduleCallBack, Pointer pUsrData);
    ...
    //Import the facial library. The mapping camera version is V5R19C30 TR5 and earlier versions.
    boolean IVS_PU_ImportFaceLib(ULONG ulIdentifyID, PU_FACE_LIB_IMPORT_S pstFaceLibInfo);

    //Extended interface for importing the face library (the import speed can be improved). This interface is used with IVS_PU_CheckImportStatus (camera version: V500R019C30 TR6 or later).
    boolean IVS_PU_ImportFaceLibEx(ULONG ulIdentifyID, PU_FACE_LIB_IMPORT_S pstFaceLibInfo);

    //Periodically query the status of importing data into the face library and the feature extraction status.
    ...
    //Obtain/Set parking violation detection parameters of the traffic PTZ dome camera.
    boolean IVS_PU_GetTrafficDomeManualDetectionParams(ULONG ulIdentifyID, PU_TD_MANUAL_DETECTION_PARAMS pstManualDecetionParams);
    boolean IVS_PU_SetTrafficDomeManualDetectionParams(ULONG ulIdentifyID, PU_TD_MANUAL_DETECTION_PARAMS pstManualDecetionParams);

    //Obtain/Set parking violation detection parameters V2 of the traffic PTZ dome camera.
    boolean IVS_PU_GetTrafficDomeManualDetectionParamsV2(ULONG ulIdentifyID, PU_TD_MANUAL_DETECTION_PARAMSV2 pstManualDecetionParams);
    boolean IVS_PU_SetTrafficDomeManualDetectionParamsV2(ULONG ulIdentifyID, PU_TD_MANUAL_DETECTION_PARAMSV2 pstManualDecetionParams);
    ...
    boolean IVS_PU_GetTrafficDomeIllegalIntelligentParams(ULONG ulIdentifyID, PU_TD_TRAFFIC_DOME_ILLEGAL_INTELLIGENT_PARAMS pstTDomeIllegalIntelligentParams);
    boolean IVS_PU_SetTrafficDomeIllegalIntelligentParams(ULONG ulIdentifyID, PU_TD_TRAFFIC_DOME_ILLEGAL_INTELLIGENT_PARAMS pstTDomeIllegalIntelligentParams);

    //Obtain the default intelligent violation analysis parameter setting of the traffic PTZ dome camera.
    boolean IVS_PU_GetTrafficDomeIllegalIntelligentDeFaultParams(ULONG ulIdentifyID, PU_TD_TRAFFIC_DOME_ILLEGAL_INTELLIGENT_PARAMS pstTDomeIllegalIntelligentParams);
    ...
    //Obtain the tour scene status (enabled or disabled) of the traffic PTZ dome camera.
    boolean IVS_PU_GetTrafficDomeSceneEnableInfo(ULONG ulIdentifyID, PU_TD_SCENE_ENABLE_INFO pstSceneEnableInfo);

    /*Smart tracking (linkage between a box or bullet camera and a PTZ dome camera).*/
    ...
    boolean IVS_PU_SetMasterSlaveGroupPara(ULONG ulIdentifyID, PU_MASTER_SLAVE_PER_GROUP_PARA pstMasterSlavePerGroupPara);
    ...
    boolean IVS_PU_GetMasterSlaveCommunicationPara(ULONG ulIdentifyID, PU_MASTER_SLAVE_COMMUNICATION_PARA pstMasterSlaveCommunicationPara);
    ...
    boolean IVS_PU_GetMasterSlaveWatchPointPara(ULONG ulIdentifyID, PU_PTZ_CURRENT_LOCATION pstMasterSlaveWatchPointPara);

    boolean IVS_PU_SetMasterSlaveWatchPointPara(ULONG ulIdentifyID, PU_PTZ_CURRENT_LOCATION pstMasterSlaveWatchPointPara);

    //master slave locate para
    boolean IVS_PU_GetMasterSlaveLocateConfig(ULONG ulIdentifyID, PU_MASTER_SLAVE_LOCATE_CONFIG pstMasterSlaveLocateConfig);

    boolean IVS_PU_SetMasterSlaveLocateConfig(ULONG ulIdentifyID, PU_MASTER_SLAVE_LOCATE_CONFIG pstMasterSlaveLocateConfig);
    ...
    boolean IVS_PU_GetMasterSlaveCalibrationPara(ULONG ulIdentifyID, PU_MASTER_SLAVE_CALIBRATION_STATUS pstMasterSlaveCalibrationPara);

    boolean IVS_PU_SetMasterSlaveCalibrationPara(ULONG ulIdentifyID, PU_MASTER_SLAVE_CALIBRATION_STATUS pstMasterSlaveCalibrationPara);

    //master slave calibration status
    boolean IVS_PU_GetMasterSlaveCalibrationStatus(ULONG ulIdentifyID, PU_MASTER_SLAVE_CALIBRATION_STATUS pstMasterSlaveCalibrationStatus);

    //master slave track para
    boolean IVS_PU_MasterSlaveManualTrack(ULONG ulIdentifyID, PU_MASTER_SLAVE_MANUAL_TRACK_PARA pstMasterSlaveManualTrackPara);
    ...
    /*******************************************************************************************************************/
    // eLayTwo C type is LAYER_TWO_TYPE， pstMetaData c type is PU_META_DATA **pstMetaData
    ...
    // bussLevel C type is PU_AI_LEVEL_E， bussName c type is PU_AI_NAME_E, param C type is  const void*
    ...
    long IVS_PU_CommonOption(ULONG ulIdentifyID, int enGetOrSet, int enServiceType, Pointer pstParam, ULONG ulParam_len);


    //Interface for setting and obtaining parameters in JSON format.
    long IVS_PU_JsonConfig_Option(ULONG ulIdentifyID, LPPU_CONFIG_JSON_INPUT_ST pInputParam, LPPU_CONFIG_JSON_CONFIG_OUTPUT_ST pOutputParam);

    //Function of setting JSON alarm callback.
    // dwBufLen is Monitoring handle   dwEventType C type is EM_REALPLAY_DISCONNECT_EVENT_TYPE   pMsginfo,pUserData C type is void*
    ...
    /******************************************************************************
     *  Note    : Type of the memory allocation callback function.
     * Parameter: uiChannelID - [in] channel ID
     *                 uiSize - [in] memory size
     * Return value: If the operation succeeds, the memory address is returned.
    ...
    /******************************************************************************
     * Note: Type of the memory release callback function.
     * Parameter: uiChannelID - [in] channel ID
    ...
    /******************************************************************************
     * Note: Log callback function type
     * Parameter: uiChannelID - [in] channel ID
     *                 eLevel - [in] Log level
     *					 pszMsg - [in] Log content (character string).
    ...
    public interface PU_VIDEO_ALG_LOG_LEVEL {
        ...
        public static final int PU_VIDEO_ALG_LOG_DEBUG = 3;        // Debug information, which provides reference for R&D personnel to perform debugging.
    }
}