...
import cn.edu.xust.iot.sdc.service.IBussinessRealPlay;
 ...
 */
@Slf4j
public class BussinessRealPlayImpl implements IBussinessRealPlay {
	...
	public boolean stop() {
		try {
			boolean ret = HWPuSDK.INSTANCE.IVS_PU_StopRealPlay(new ULONG(GlobalVariant.lLoginID),
					new ULONG(BussinessRealPlayImpl.ret));
